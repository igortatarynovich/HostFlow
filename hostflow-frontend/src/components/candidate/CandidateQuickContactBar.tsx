...
export function CandidateQuickContactBar({
  ...
  return (
    ...
    >
      <p className="text-sm font-semibold text-slate-900">{t('app.candidate_card.quick_contact.title')}</p>
      <p className="mt-1 text-sm text-slate-600">{t('app.candidate_card.quick_contact.subtitle')}</p>
      <div className="mt-3 flex flex-wrap gap-2">
        {telHref ? (
          ...
          >
            ...
            {t('app.candidate_card.quick_contact.call')}
          </a>
        ) : null}
