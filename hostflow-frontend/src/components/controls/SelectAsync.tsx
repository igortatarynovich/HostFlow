      ...
      {open && (
        <div className="absolute z-20 mt-1 w-full rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden">
          ...
          <div className="max-h-64 overflow-auto">
            ...
            {!loading && opts.length === 0 && <div className="px-3 py-2 text-sm text-gray-500">нет совпадений</div>}
            {opts.map(o => (
              <div
                key={o.value}
                className={clsx('px-3 py-2 cursor-pointer hover:bg-gray-50', o.value===value && 'bg-gray-100')}
