...
export const NAV_ITEMS: NavItem[] = [
  ...
  {
    key: 'organization',
    labelKey: 'app.nav.items.organization',
    path: CRM.organization,
    group: 'account',
    permission: ['settings.view', 'companies.view', 'admin.users'],
  },
  {
    key: 'my-company',
...
export const APP_ROUTES: AppRouteConfig[] = [
  ...
  { key: 'organization', path: seg(CRM.organization), Component: OrganizationHubPage, permission: ['settings.view', 'companies.view', 'admin.users'] },
  ...
  { key: 'settings-billing', path: seg(CRM.settingsBilling), Component: BillingWorkspacePage, permission: 'admin.users' },
  {
    ...
    path: seg(CRM.settingsBillingPlan),
    Component: BillingPlanMatrixPage,
    permission: 'admin.users',
  },
