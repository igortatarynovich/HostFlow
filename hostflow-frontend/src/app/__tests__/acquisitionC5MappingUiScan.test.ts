...
describe('C-5 Mapping workspace UI shell', () => {
  ...
  it('page wires get/put mapping, projection, and applied evidence', () => {
    ...
    expect(src).toContain('marketing-mapping-projection-empty')
    expect(src).toContain('marketing-mapping-close-path')
    expect(src).toContain('mappingClosePath')
    ...
    expect(src).toContain('groupMappingDestinations')
    expect(src).toContain('DESTINATION_IGNORE')
    expect(src).toContain('app.marketing.mapping.destination.ignore')
    expect(src).toContain('app.marketing.mapping.action.unset')
    expect(src).toContain('bindingFromDestinationSelect')
