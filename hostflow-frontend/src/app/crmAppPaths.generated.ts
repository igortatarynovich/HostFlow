...
export const CRM_APP_PATHS = {
  ...
  companiesOperatingBilling: "/app/companies?role=operating&section=billing",
...
export const CRM_APP_DRILLDOWN_HREFS = {
  ...
  tasksOverdueReminders: "/app/tasks?tab=tasks&t_status=active&t_due_bucket=overdue",
  tasksLeadsSlaNudges: "/app/tasks?tab=tasks&t_status=active&t_entity=lead",
  tasksCandidateOverdueNextAction: "/app/tasks?tab=tasks&t_status=active&t_entity=candidate",
