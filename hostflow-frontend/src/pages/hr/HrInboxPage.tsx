                              ...
                              <div className="flex flex-col items-end gap-1">
                                {primaryCaseHref(row) ? (
                                  <Link
                                    className={
                                      isPickup
                                        ? 'btn-primary btn-sm text-left'
                                        : 'text-sm font-medium text-brand-700 hover:underline'
                                    }
                                    to={primaryCaseHref(row)!}
                                    data-testid={isPickup ? 'hr-inbox-open-employment-case' : undefined}
                                  >
                                    {row.workforce_employee_id
                                      ? t('app.hr.verify_task.open_verification', { defaultValue: 'Verify documents' })
                                      : isPickup
                                        ? t('app.nav.hr.inbox.open_employment_case', {
                                            defaultValue: 'Open employment case',
                                          })
