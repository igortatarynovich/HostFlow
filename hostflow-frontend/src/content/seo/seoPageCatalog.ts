...
export const SEO_PAGE_CATALOG: SeoPageDefinition[] = [
  {
    ...
    seoTitle: { en: "Recruitment Operations for Agencies | HostFlow", ru: "Recruitment Operations для кадровых агентств | HostFlow", pl: "Recruitment Operations dla agencji rekrutacyjnych | HostFlow" },
    ...
    h1: { en: "Recruitment Operations for Agencies", ru: "Recruitment Operations для кадровых агентств", pl: "Recruitment Operations dla agencji rekrutacyjnych" },
  ...
  },
  {
    ...
    pageType: "use_case",
    badge: { en: "Use-case", ru: "Сценарий", pl: "Use-case" },
    seoTitle: { en: "Recruitment Operations for Transport Companies | HostFlow", ru: "Recruitment Operations для транспортных компаний | HostFlow", pl: "Recruitment Operations dla firm transportowych | HostFlow" },
    seoDescription: { en: "Hire drivers and warehouse staff faster with HostFlow: Meta intake, pipeline ownership, and document control in recruitment.", ru: "Нанимайте водителей и склад быстрее с HostFlow: Meta, пайплайн и контроль документов в рекрутинге.", pl: "Zatrudniaj kierowców i magazyn szybciej z HostFlow: Meta, pipeline i kontrola dokumentów w rekrutacji." },
    h1: { en: "Recruitment Operations for Transport Companies", ru: "Recruitment Operations для транспортных компаний", pl: "Recruitment Operations dla firm transportowych" },
    subtitle: { en: "Keep hiring operational — from ad lead to document readiness in recruitment.", ru: "Держите найм операционным — от лида из рекламы до готовности документов в рекрутинге.", pl: "Utrzymaj rekrutację operacyjną — od leada z reklamy do gotowości dokumentów w rekrutacji." },
    ...
    faq: [
      ...
      },
      {
        ...
        a: { en: "HostFlow covers recruitment operations that people often look for in a CRM or ATS — without requiring a second disconnected system.", ru: "HostFlow закрывает recruitment operations, которые обычно ищут в CRM или ATS — без второго отключённого контура.", pl: "HostFlow pokrywa recruitment operations, których ludzie często szukają w CRM lub ATS — bez drugiego rozłączonego systemu." },
      },
    ],
    related: [
      { path: "/use-cases/trucking-recruitment", label: { en: "Trucking recruitment", ru: "Рекрутинг водителей", pl: "Rekrutacja kierowców" } },
  ...
  },
  {
    ...
    pageType: "use_case",
    badge: { en: "Use-case", ru: "Сценарий", pl: "Use-case" },
    seoTitle: { en: "Driver Recruitment for Transport Teams | HostFlow", ru: "Рекрутинг водителей для транспортных команд | HostFlow", pl: "Rekrutacja kierowców dla zespołów transportowych | HostFlow" },
    seoDescription: { en: "Driver recruitment for transport teams: Meta leads, CE document checks, stage ownership, and reminders so vacancies close faster.", ru: "Рекрутинг водителей для транспортных команд: лиды Meta, проверка CE-документов, этапы и напоминания — вакансии закрываются быстрее.", pl: "Rekrutacja kierowców dla zespołów transportowych: leady Meta, kontrola dokumentów CE, etapy i przypomnienia — wakaty zamykane szybciej." },
    h1: { en: "Driver Recruitment for Transport Teams", ru: "Рекрутинг водителей для транспортных команд", pl: "Rekrutacja kierowców dla zespołów transportowych" },
    subtitle: { en: "Turn driver applications into a controlled hiring process without spreadsheet chaos.", ru: "Превращайте заявки водителей в контролируемый процесс найма без хаоса таблиц.", pl: "Zamieniaj zgłoszenia kierowców w kontrolowany proces rekrutacji bez chaosu arkuszy." },
  ...
  },
  {
    ...
    seoTitle: { en: "WhatsApp in Recruitment Workflows | HostFlow", ru: "WhatsApp в recruitment workflows | HostFlow", pl: "WhatsApp w workflow rekrutacji | HostFlow" },
    ...
    h1: { en: "WhatsApp in the recruitment workflow", ru: "WhatsApp в процессе рекрутинга", pl: "WhatsApp w workflow rekrutacji" },
    ...
    problemTitle: { en: "WhatsApp without recruitment context", ru: "WhatsApp без контекста рекрутинга", pl: "WhatsApp bez kontekstu rekrutacji" },
    problemItems: [
  ...
  },
  {
    ...
    pageType: "feature",
    badge: { en: "Feature", ru: "Функция", pl: "Feature" },
    seoTitle: { en: "Meta Ads Recruitment Intake | HostFlow", ru: "Intake Meta Ads для рекрутинга | HostFlow", pl: "Intake Meta Ads do rekrutacji | HostFlow" },
    ...
    h1: { en: "Meta Ads recruitment intake", ru: "Intake Meta Ads для рекрутинга", pl: "Intake Meta Ads do rekrutacji" },
    ...
    problemTitle: { en: "Ads without an operational recruitment process", ru: "Реклама без операционного процесса рекрутинга", pl: "Reklamy bez operacyjnego procesu rekrutacji" },
    problemItems: [
  ...
  },
  {
    ...
    seoDescription: { en: "Applicant tracking for driver hiring — stages, documents, and Meta intake with operational ownership.", ru: "Трекинг заявок при найме водителей — этапы, документы и Meta с операционной ответственностью.", pl: "Tracking zgłoszeń przy rekrutacji kierowców — etapy, dokumenty i Meta z ownership operacyjnym." },
    ...
    solutionTitle: { en: "Applicant tracking with operational control", ru: "Трекинг заявок с операционным контролем", pl: "Tracking zgłoszeń z kontrolą operacyjną" },
    solutionBody: { en: "HostFlow provides applicant tracking with recruiter ownership, Meta intake, and document control for driver roles.", ru: "HostFlow даёт трекинг заявок с ответственностью рекрутера, Meta и контролем документов для водителей.", pl: "HostFlow zapewnia tracking zgłoszeń z ownership rekrutera, Meta i kontrolą dokumentów dla kierowców." },
    ...
    flowItems: [
      ...
      { en: "Verify documents before hire decision.", ru: "Проверяйте документы до решения о найме.", pl: "Weryfikuj dokumenty przed decyzją o zatrudnieniu." },
    ...
    faq: [
      {
        ...
        a: { en: "HostFlow overlaps with ATS and CRM products; Recruitment is the first module of a modular platform for transport companies.", ru: "HostFlow пересекается с продуктами ATS и CRM; Recruitment — первый модуль модульной платформы для транспортных компаний.", pl: "HostFlow pokrywa się z produktami ATS i CRM; Recruitment to pierwszy moduł modularnej platformy dla firm transportowych." },
      },
      {
    ...
    related: [
      ...
      { path: "/use-cases/driver-recruitment", label: { en: "Driver recruitment", ru: "Рекрутинг водителей", pl: "Rekrutacja kierowców" } },
  ...
  },
  {
    ...
    related: [
      { path: "/use-cases/transport-companies", label: { en: "Transport companies", ru: "Транспортные компании", pl: "Firmy transportowe" } },
  ...
  },
  {
    ...
    subtitle: { en: "Hire across EU markets with one recruitment system — clear ownership, documents, and compliant communication paths.", ru: "Нанимайте на рынках EU в одной системе рекрутинга — ответственность, документы и compliant-коммуникации.", pl: "Rekrutuj na rynkach UE w jednym systemie rekrutacji — ownership, dokumenty i ścieżki compliant komunikacji." },
