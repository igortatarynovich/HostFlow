    ...
    >
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        {previewVisible && previewSlot ? (
          <div className="max-h-[min(48vh,480px)] min-h-0 shrink-0 overflow-y-auto overscroll-contain border-b border-slate-200/80 px-2.5 py-2">
            {previewSlot}
          </div>
        ) : null}
        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain border-t border-slate-200/90 bg-slate-50/70 px-2.5 py-2">
          {controlsSlot}
        </div>
      </div>
    </aside>
