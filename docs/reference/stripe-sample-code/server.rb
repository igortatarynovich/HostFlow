...
# Reference sample only: never hardcode keys in source.
# Use environment variable STRIPE_SECRET_KEY for local experiments.
Stripe.api_key = ENV.fetch('STRIPE_SECRET_KEY', 'sk_test_replace_me')
...
post '/webhook' do
  ...
  webhook_secret = ENV.fetch('STRIPE_WEBHOOK_SECRET', 'whsec_replace_me')
