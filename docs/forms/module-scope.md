...
**Rule:** Field Catalog is SoT; Builder is a Catalog **client**. Descriptors are **declarative**. **P1.1–P1.3** deliver Registry + Descriptors + Basic stdlib. **Builder UNLOCKED** after P1.3; preferred next = **P1.4 Extension API**, then P2.
