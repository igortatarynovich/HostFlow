...
**Rule:** Field Catalog is SoT; Builder is a Catalog **client**. **P1.1–P1.3 COMPLETE**; Builder **UNLOCKED**. Next: **P1.4 Extension API** (then P2) — modules register via public surface; no Basic override; unified catalog read.
