...
**Rule:** Field Catalog is SoT; Builder is a Catalog **client**. Descriptors are **declarative** (no executable logic). Builder **LOCKED** until **P1.3**. **P1.1 COMPLETE**. **P1.2 Design ACTIVE** · Descriptor Contract **READY FOR IMPLEMENTATION**. **P1.3 LOCKED**.
