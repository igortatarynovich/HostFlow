...
**Rule:** P1 Foundation **CLOSED**; Catalog v1 **FROZEN**. **Builder Catalog Consumption ACTIVE** — P2.1–P2.3 **COMPLETE**; **P2.4 Persistence READY**. P3 Publish UI / P4 Themes / P5 Analytics **LOCKED**.
