...
**Rule:** Field Catalog is SoT; Builder is a Catalog **client**. Descriptors are **declarative**. Builder **LOCKED** until **P1.3**. **P1.1–P1.2 COMPLETE**. **P1.3 — READY FOR IMPLEMENTATION** (stdlib via public contracts only).
