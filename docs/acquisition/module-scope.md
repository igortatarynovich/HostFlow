...
7b. **Stage 4 product/UI cutover** — ❌ **NOT DONE** / **ACTIVE Product Track = C-5** — [`../specs/tasks/acquisition-ui-cutover.md`](../specs/tasks/acquisition-ui-cutover.md) (C-1 ✅ #157 · C-2 ✅ #158 **with constraints** · C-3 ✅ #160 **with constraints** · **C-3.1 ✅** · **C-4 ✅** smoke PASS · **C-5 Mapping workspace**; C-7 PASS closes cutover → then Diagnostics / Stage 5+ as product evolution)  
