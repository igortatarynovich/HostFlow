...
- [ ] Forms Platform (C2 Contract Identity): см. [`threat-models/forms-platform.md`](threat-models/forms-platform.md) (frozen publication identity, tenant resolve, submit pin, no draft-as-publication, fail-closed backfill).
