...
- [ ] Source Diagnostics (PR1): см. [`threat-models/acquisition-source-diagnostics.md`](threat-models/acquisition-source-diagnostics.md) (read-only Lead + Activity compose; tenant scope; no replay/write on GET).
