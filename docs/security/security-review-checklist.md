...
- [ ] Marketing Sources (C-3): см. [`threat-models/acquisition-marketing-sources.md`](threat-models/acquisition-marketing-sources.md) (GET-only inventory, tenant filter, no raw payload dump, no ingest mutation).
