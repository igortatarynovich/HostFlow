...
- [ ] Source Diagnostics (PR1–PR4): см. [`threat-models/acquisition-source-diagnostics.md`](threat-models/acquisition-source-diagnostics.md) (read-only Lead + Activity compose; filters; duplicate surface; mapping/Mapping Health; tenant scope; no replay/write on GET).
