...
**Generated:** 2026-07-29T09:11:48Z (UTC)  
...
| Threat models | Files under `docs/security/threat-models/` | 14 | ≥ 10 | `green` | threat-model gate enforces updates when surface code changes. |
