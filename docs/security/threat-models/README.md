...
| [acquisition-stage-6-analytics.md](./acquisition-stage-6-analytics.md) | Stage 6 PR-1…PR-4: Flight compare, day/week cohorts, CAC proxy, company portfolio (no new ledger, no Runtime writes) |
