...
| [acquisition-source-diagnostics.md](./acquisition-source-diagnostics.md) | Source Diagnostics PR1–PR5: read-only Lead + Activity casework, filters, duplicate, Mapping Health, ingest mapping stamp + drift; no replay/write |
