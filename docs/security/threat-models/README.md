...
| [acquisition-source-diagnostics.md](./acquisition-source-diagnostics.md) | Source Diagnostics PR1–PR4: read-only Lead + Activity casework, filters, duplicate surface, mapping/Mapping Health; no replay/write |
