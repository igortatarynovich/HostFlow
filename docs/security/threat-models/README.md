...
| [acquisition-stage-6-analytics.md](./acquisition-stage-6-analytics.md) | Stage 6 PR-1/PR-2: Flight compare + windowed day cohorts / CAC proxy (no new ledger, no Runtime writes) |
