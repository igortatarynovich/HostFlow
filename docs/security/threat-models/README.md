...
| [acquisition-source-diagnostics.md](./acquisition-source-diagnostics.md) | Source Diagnostics PR1–PR3: read-only Lead + Activity casework, filters, duplicate surface; no replay/write |
