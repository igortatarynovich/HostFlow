...
| [acquisition-source-diagnostics.md](./acquisition-source-diagnostics.md) | Source Diagnostics PR1–PR2: read-only Lead + Activity casework + list filters, tenant isolation, no replay/write |
