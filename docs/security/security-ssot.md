...
Незакрытой осознанно остаётся одна таблица — `tenants`, причина и владелец записаны в `backend/tests/security/rls_uncovered_tables.txt`.
...
| RLS coverage (tenant tables) | 100% — **измерено 2026-08-30: все, кроме одной названной таблицы** (`tenants`, владелец TI-5); было 124/226 ≈ 55% на 2026-08-28, см. §3 «Измеренное состояние» |
