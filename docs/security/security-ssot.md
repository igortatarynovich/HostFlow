...
Documents Platform E3 (authenticated Hub metadata resolve via Document Link, not file download): [`threat-models/documents-platform.md`](threat-models/documents-platform.md). Uploads / MIME / storage ACL remain [`threat-models/document-uploads.md`](threat-models/document-uploads.md).
...
Детали: `docs/specs/architecture/object_storage.md`, `threat-models/document-uploads.md`, `threat-models/public-links.md`, `threat-models/documents-platform.md` (E3 metadata resolve, not bytes).
