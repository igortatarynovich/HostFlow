...
**Product Track (live):** [Documents Platform E2 — Public contract & D2 slot enable](../specs/tasks/documents-platform-e2-public-contract.md) ([#271](https://github.com/igortatarynovich/HostFlow/pull/271); feat locked). E1 ✅. D2 `documents` catalog unlock is E2; D3–D9 stay unbound.  
