...
| **RB-2** | Apply migrations to a fresh and to an existing database | RR3, RC condition 4 | igortatarynovich | [OL-2](../specs/tasks/operate-and-launch.md) | **MISSING** — `alembic upgrade heads` currently fails on a fresh DB ([AGENTS.md](../../AGENTS.md) § Migration caveats) |
