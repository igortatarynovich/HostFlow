...
6. **Platform Extraction** (active — Kit Gate) — [phase](../architecture/platform-extraction-phase.md) · [Core Platform Kit](../tasks/ui-platform-composition-epic.md): K1 `DataTable` · K2 `ListWorkspace` · K3 `EntityWorkspace`; Analytics public composition already in `components/analytics`.  
