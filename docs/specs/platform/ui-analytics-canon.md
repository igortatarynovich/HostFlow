...
- 2026-08-13: **Platform Inventory** ([platform-inventory.md](platform-inventory.md)). Kit Gate **PASS_WITH_CONSTRAINTS**; `ChartFrame` remains implementation inside family charts (KG-C4). Other dashboards still migrate-on-touch.
