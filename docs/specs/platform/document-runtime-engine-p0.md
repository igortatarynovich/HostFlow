...
**Next practical downstream track:** [`document-expiry-notifications-p0.md`](document-expiry-notifications-p0.md) — Document Expiry Notifications P2 complete; **P3 Notification Center read UI** next.
...
- 2026-06-23: Cross-link — Document Expiry Notifications P2 complete; P3 Notification Center read UI next.
