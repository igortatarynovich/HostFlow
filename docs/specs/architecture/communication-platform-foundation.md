...
2. **C2 — Capability epic** — **active C2.1** ([epic](../tasks/epic-c2-communication-campaigns.md) · [C2.1](../tasks/c2-1-template-platform.md)); Intent-only; no Thread model changes  
