...
| **List Workspace Canon** | `collection_orchestration` / `ListWorkspace`; modules pass `ListDefinition` + data; `DataTable` is a representation ([`ADR-044`](ADR-044-list-workspace-data-presentation-canon.md) · [`../platform/ui-list-workspace-canon.md`](../platform/ui-list-workspace-canon.md)) |
