...
- 2026-09-16: **ADR-042** — Ready composition **PARKED**; next = [`../tasks/platform-modularization-isolation-cutover.md`](../tasks/platform-modularization-isolation-cutover.md) before Kernel — [`ADR-042-spine-policy-separation.md`](ADR-042-spine-policy-separation.md).
