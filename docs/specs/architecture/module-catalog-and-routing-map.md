...
- 2026-09-15: **ADR-042** (**Accepted**) — Kernel preflight STOP → [`../tasks/admit-policy-ruleset-separation.md`](../tasks/admit-policy-ruleset-separation.md) **OPEN** (Admit process-policy vs PEM-1 ruleset) before Kernel retry — [`ADR-042-spine-policy-separation.md`](ADR-042-spine-policy-separation.md).
