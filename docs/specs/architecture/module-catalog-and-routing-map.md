...
| **Process Engine** | Process Engine | [`process-engine.md`](../platform/process-engine.md) · [`ADR-037`](ADR-037-lifecycle-identity-canon.md) · [hiring-acceptance-contract.md](hiring-acceptance-contract.md) · [hiring-stage-authority-consumption.md](hiring-stage-authority-consumption.md) · [hiring-eligibility-composition.md](hiring-eligibility-composition.md) | Business modules; Hiring E2E walk | Process contracts |
