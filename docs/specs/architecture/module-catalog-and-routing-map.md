...
- 2026-09-15: **ADR-042** (Proposed) — Spine / Policy Separation amended: top-down **life path → process → module → policy**; Full Spine (kernel) ≠ PEM-1 (policy composition); bans bottom-up document→route — [`ADR-042-spine-policy-separation.md`](ADR-042-spine-policy-separation.md) · inventory [`../tasks/spine-policy-separation-inventory.md`](../tasks/spine-policy-separation-inventory.md).
