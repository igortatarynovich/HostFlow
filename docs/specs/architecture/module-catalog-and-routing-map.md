...
|---|--------|--------------------------------------------------|
| **1** | **Recruitment** | **Applications** (inbound + Fits), **Candidates** (Recruitment process → Ready for employment → Transfer), **Vacancies**, **job posts**, **job publishing**, подбор, handoff; pipeline только по Application/Candidate ([`ADR-008`](ADR-008-job-publishing-and-distribution.md), [`ADR-023`](ADR-023-recruitment-sales-module-separation.md), [`ADR-042`](ADR-042-operator-host-boundary.md)); **не** Sales Inquiry / ClientAccount / employees lifecycle / Formalize / Started / fleet / services / invoices |
| **2** | **HR / Kadry** | Employee profile, HR cases, lifecycle, contracts, ZUS, work permits, employee docs, payroll data, onboarding/termination; **после Transfer** — employability / Formalize / Employee / Started ([`ADR-042`](ADR-042-operator-host-boundary.md)); **автономен** без Recruitment |
...
- 2026-09-11: **Vacancy Overlay Write UI** — operator requirements → Profile + Overlay delta (no lead_criteria / Profiling layer) — [`../tasks/vacancy-overlay-write-ui.md`](../tasks/vacancy-overlay-write-ui.md).
- 2026-09-10: **ADR-042** (Accepted — L2 hosting; runtime cutover later) — operator hosts Application (Fits) → Candidate (Recruitment → Ready for employment → Transfer) → HR (ESO-1…5). Seamless handoff ≠ one Application card. Full Spine one-card PASS withdrawn — [`ADR-042-operator-host-boundary.md`](ADR-042-operator-host-boundary.md).
- 2026-09-10: **Full Spine Gate STOP** — superseded by ADR-042; do not retune the one-card freeze — [`../gates/full-spine-gate.md`](../gates/full-spine-gate.md).
