...
| Entity Workspace Phase D | D1 ✅ · D2 ✅ · D3 ✅ ([brief](../tasks/entity-workspace-d3-consumer-cutover.md) · [#256](https://github.com/igortatarynovich/HostFlow/pull/256)); D4 [brief](../tasks/entity-workspace-d4-candidate-cutover.md) (feat locked); slot catalog; no Passport; D2 `documents` reserved |
