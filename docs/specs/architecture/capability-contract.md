...
| Entity Workspace Phase D | D1 ✅ · D2 ✅ · D3 ✅ ([brief](../tasks/entity-workspace-d3-consumer-cutover.md); named Cutover Gate); D4 brief locked; slot catalog; Sales Inquiry first consumer; no Passport |
