...
| Entity Workspace Phase D | D1 ✅ · D2 ✅ ([brief](../tasks/entity-workspace-d2-composition-contract.md); named Composition Gate); D3 brief locked; slot catalog; no Passport |
