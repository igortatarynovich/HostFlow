...
| Artifact | Path |
|----------|------|
| E1 / E2 / E3 / E4 / E5 / E6 / E7 tasks | [`../tasks/documents-platform-e1-contract-seal.md`](../tasks/documents-platform-e1-contract-seal.md) ✅ · [`documents-platform-e2-public-contract.md`](../tasks/documents-platform-e2-public-contract.md) ✅ · [`documents-platform-e3-first-consumer-bind.md`](../tasks/documents-platform-e3-first-consumer-bind.md) ✅ · [`documents-platform-e4-candidate-document-link.md`](../tasks/documents-platform-e4-candidate-document-link.md) ✅ · [`documents-platform-e5-candidate-storage-bridge.md`](../tasks/documents-platform-e5-candidate-storage-bridge.md) ✅ · [`documents-platform-e6-document-expiry.md`](../tasks/documents-platform-e6-document-expiry.md) ✅ · [`documents-platform-e7-document-requests.md`](../tasks/documents-platform-e7-document-requests.md) (feat) |
...
Candidate Document Link consume = [E4](../tasks/documents-platform-e4-candidate-document-link.md) ✅. Storage-bridge retirement (`candidate_id` drop) = [E5](../tasks/documents-platform-e5-candidate-storage-bridge.md) ✅. Document expiry / validity = [E6](../tasks/documents-platform-e6-document-expiry.md) ✅. Document requests = [E7](../tasks/documents-platform-e7-document-requests.md). D3 / D5–D7 / D9 unbound. Foundation stays 🔄.  
...
- 2026-08-22: Documents Platform E5 brief — Candidate storage-bridge retirement (`candidate_id` drop); this file stays E2 contract inventory (no id bump).
- 2026-08-22: Documents Platform E4 feat — Candidate Document Link resolve (`candidate` / `primary`); this file stays E2 contract inventory (no id bump).
