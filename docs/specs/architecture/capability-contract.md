...
| Entity Workspace Phase D | D1 ✅ · D2 ✅ · D3 ✅ · D4 ✅ · D5 ✅ ([brief](../tasks/entity-workspace-d5-client-cutover.md) · [#260](https://github.com/igortatarynovich/HostFlow/pull/260)); D6 [brief](../tasks/entity-workspace-d6-sales-order-cutover.md) (feat; named Cutover Gate); slot catalog; no Passport; D2 `documents` reserved |
