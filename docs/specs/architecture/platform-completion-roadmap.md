...
**Phase B** ← ✅ Meta / Stage 3 slice 3–4 closed. **Phase C — Forms Platform** ← ✅ C1–C6 / Foundation ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). **Phase D — Entity Workspace** ← **active** ([D8](../tasks/entity-workspace-d8-hr-employee-cutover.md) feat; named Cutover Gate; D7 ✅ [#264](https://github.com/igortatarynovich/HostFlow/pull/264); D6 ✅; D5 ✅; D4 ✅; D3 ✅; D2 ✅; D1 ✅).
...
3. **Phase C — Forms Platform** ← ✅ ([C1](../tasks/forms-platform-c1-contract-seal.md)…[C6](../tasks/forms-platform-c6-optimization.md) / Foundation) → **Phase D — Entity Workspace** ← **active** ([D8](../tasks/entity-workspace-d8-hr-employee-cutover.md) feat; D7 ✅; D6 ✅; D5 ✅; D4 ✅; D3 ✅; D2 ✅; D1 ✅) → Documents → Billing → AI  
...
## Phase D — Universal Entity Workspace ← **active** (D8 feat; D7 ✅)
...
| **D8** | HR employee cutover | [brief](../tasks/entity-workspace-d8-hr-employee-cutover.md) (feat; named Cutover Gate) |
...
| 5 | **D** Universal Entity Workspace | ← **active** (D8 [brief](../tasks/entity-workspace-d8-hr-employee-cutover.md); feat; named Cutover Gate) |
...
5. Parallel product branches that compete across phases (one active product slice). Phase D (Entity Workspace D8 feat; named Cutover Gate) **is** the active phase; do not reopen Forms C6, Stage 5 settings, or R6.  
...
9. Starting D9 Services `/app/orders` cutover before the D9 brief merges.
...
| Doc | Role |
|-----|------|
| [sales-to-comms-sequential-queue.md](../tasks/sales-to-comms-sequential-queue.md) | **Near-term** slice order (active = Entity Workspace D8 feat; named Cutover Gate) |
