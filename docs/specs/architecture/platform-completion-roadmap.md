...
D1–D9 closed chrome + D2 **surfaces** + named consumer binds. That was a **substituted** goal. This slice seals the **Capability Host Contract** (host places; owners own semantics). Entity Workspace and Application Workspace stay distinct; both implement the same contract. Proof = Recruitment Application.
...
**Ref:** [workspace-capability-platform-completion.md](../tasks/workspace-capability-platform-completion.md) · [D2](../tasks/entity-workspace-d2-composition-contract.md) · [UI constitution §3 / §10](ui-constitution-v1.md).

---

## Phase E — Documents Platform ← **locked** (E1 ✅; E2 brief ✅; feat after Workspace Capability Goal Completion)
...
| **E2** | Public contract / D2 `documents` catalog enable | [brief](../tasks/documents-platform-e2-public-contract.md) [#271](https://github.com/igortatarynovich/HostFlow/pull/271) (docs ✅; **feat locked** until Workspace Capability Goal Completion) |
...
| 5b | **Workspace Capability Platform Completion** | Capability Host Contract; proof = Recruitment Application ← **active** |
...
5. Parallel product branches that compete across phases (one active product slice). **Workspace Capability Platform Completion** **is** the active slice; do not start Documents E2 feat, D10-on-weak-D2, Recruitment rail patches, reopen D9, Forms C6, Stage 5 settings, or R6. Do not fold Application into Entity. Do not multiply new screens until Recruitment Application Goal Completion (not a widget kit, not Candidate). Closing a later phase as COMPLETE requires the [Goal Completion Gate](../gates/goal-completion-gate.md). New platform phase briefs require [Original Goal → Completion Proof](../gates/goal-completion-gate.md).  
...
| Doc | Role |
|-----|------|
| [sales-to-comms-sequential-queue.md](../tasks/sales-to-comms-sequential-queue.md) | **Near-term** slice order (active = Workspace Capability Platform Completion; E2 feat locked) |
| [workspace-capability-platform-completion.md](../tasks/workspace-capability-platform-completion.md) | Corrective Product Track — Capability Host Contract |
