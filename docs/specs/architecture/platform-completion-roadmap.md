...
## Phase E — Documents Platform ← **active** (E4 brief)
...
| **E4** | Candidate Document Link bind (D4) | [brief](../tasks/documents-platform-e4-candidate-document-link.md) (feat locked) |
...
| 6 | **E** Documents Platform | ← **active** ([E4](../tasks/documents-platform-e4-candidate-document-link.md); brief; feat locked). E3 ✅ |
...
| Doc | Role |
|-----|------|
| [sales-to-comms-sequential-queue.md](../tasks/sales-to-comms-sequential-queue.md) | **Near-term** slice order (active = Documents Platform E4 brief) |
