...
**Phase B** ← ✅ Meta / Stage 3 slice 3–4 closed. **Phase C — Forms Platform** ← ✅ C1–C6 / Foundation ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). **Phase D — Entity Workspace** ← **active** ([D8](../tasks/entity-workspace-d8-hr-employee-cutover.md) brief; feat locked; D7 ✅ [#264](https://github.com/igortatarynovich/HostFlow/pull/264); D6 ✅; D5 ✅; D4 ✅; D3 ✅; D2 ✅; D1 ✅).
...
3. **Phase C — Forms Platform** ← ✅ ([C1](../tasks/forms-platform-c1-contract-seal.md)…[C6](../tasks/forms-platform-c6-optimization.md) / Foundation) → **Phase D — Entity Workspace** ← **active** ([D8](../tasks/entity-workspace-d8-hr-employee-cutover.md) brief; D7 ✅; D6 ✅; D5 ✅; D4 ✅; D3 ✅; D2 ✅; D1 ✅) → Documents → Billing → AI  
...
## Phase D — Universal Entity Workspace ← **active** (D8 brief; D7 ✅)
...
| **D8** | HR employee cutover | [brief](../tasks/entity-workspace-d8-hr-employee-cutover.md) (feat locked) |
| **D9+** | Services `/app/orders` | locked until D9 brief |

**Out of D8:** Services `/app/orders` cutover · `HrHandoffDetailPage` · D2 `documents` enable · Shell/D2 id collapse · Catalog Passport mint · Documents Phase E · Forms P3–P5 · Billing · AI · module workspace promotion into the kit · full `HrEmployeeDetailPage` rewrite · Candidate re-bind.

**Result:** one Entity Workspace without temporary side panels / one-off shells (after D ladder — not after D8 docs alone).

**Ref:** [entity-workspace-d8-hr-employee-cutover.md](../tasks/entity-workspace-d8-hr-employee-cutover.md) · [D7](../tasks/entity-workspace-d7-vacancy-cutover.md) ✅ · [D6](../tasks/entity-workspace-d6-sales-order-cutover.md) ✅ · [D5](../tasks/entity-workspace-d5-client-cutover.md) ✅ · [D4](../tasks/entity-workspace-d4-candidate-cutover.md) ✅ · [D3](../tasks/entity-workspace-d3-consumer-cutover.md) ✅ · [D2](../tasks/entity-workspace-d2-composition-contract.md) ✅ · [D1](../tasks/entity-workspace-d1-contract-seal.md) ✅ · [A2-F7](../gates/platform-governance-review-a2.md) · [ADR-010](ADR-010-unified-resource-list-shell.md).
...
| 5 | **D** Universal Entity Workspace | ← **active** (D8 [brief](../tasks/entity-workspace-d8-hr-employee-cutover.md); feat locked) |
...
5. Parallel product branches that compete across phases (one active product slice). Phase D (Entity Workspace D8 brief; feat locked) **is** the active phase; do not reopen Forms C6, Stage 5 settings, or R6.  
...
9. Starting D8 feat before this brief merges, or starting D9 Services `/app/orders` cutover before the D9 brief merges.
...
| Doc | Role |
|-----|------|
| [sales-to-comms-sequential-queue.md](../tasks/sales-to-comms-sequential-queue.md) | **Near-term** slice order (active = Entity Workspace D8 brief; feat locked) |
