...
| 6 | **E** Documents Platform | E7 ✅. DR1-runtime ✅. E8-bind ✅. E8-eval ✅. RPM program DONE. Mapping program DONE. Forms Publish Contract Gate **PASS**. Product = **FP-2** (brief; feat locked). Engineering = DONE. OCR locked |
...
2. P4 Themes / P5 Analytics while Forms product unlocks stay locked. **P3 Publish is v1 blocker 3** ([Release Goal](../gates/hostflow-v1-release-goal.md)) — contract sealed ([forms-publish-contract.md](forms-publish-contract.md)); FP-2 is named, feat locked this PR. Starting FP-2 feat work before Publish Action Gate is still forbidden. Unlock ≠ schedule.  
...
| [external-intake-forms-publish.md](../tasks/external-intake-forms-publish.md) | v1 blocker 3 — Forms Publish Contract Gate **PASS**; **FP-2** Active Product (brief; feat locked) |
