...
## Phase E — Documents Platform ← **active** (E3 feat)
...
| **E3** | First consumer bind (HR employee) + Document Link SoT | [brief](../tasks/documents-platform-e3-first-consumer-bind.md) (feat) |
...
| 6 | **E** Documents Platform | ← **active** ([E3](../tasks/documents-platform-e3-first-consumer-bind.md); feat). E2 ✅ |
...
| Doc | Role |
|-----|------|
| [sales-to-comms-sequential-queue.md](../tasks/sales-to-comms-sequential-queue.md) | **Near-term** slice order (active = Documents Platform E3 feat) |
