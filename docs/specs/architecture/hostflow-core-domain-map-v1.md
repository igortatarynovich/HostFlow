...
- **2026-09-16:** [`ADR-042`](ADR-042-spine-policy-separation.md) — Ready composition **PARKED**; next = [`../tasks/platform-modularization-isolation-cutover.md`](../tasks/platform-modularization-isolation-cutover.md) (PMI-0 PASS; PMI-1 queued).
