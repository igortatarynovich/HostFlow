...
E2 marked D2 `documents` as an **enabled platform slot**. E3 binds it on **HR employee (D8)**. E4 binds it on **Candidate (D4)** through Document Link. E5 / E6 / E7 do not add a consumer. D3 / D5–D7 / D9 stay unbound. Catalog unlock ≠ mass bind. Shell `EntityWorkspaceSectionId` `documents` ≠ this slot.
...
E1 / E2 / E3 / E4 / E5 / E6 / D1–D9 / WCP gates stay green.
