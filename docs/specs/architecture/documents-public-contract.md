...
| **E8-eval** | Same adapter. Required / optional / blocked applicability of canonical types from R5 `merge(pack, tenant_delta)` (+ Overlay as existing CL7 input). No second Adapter. No Hub packages table. Not OCR. Not mass D3–D9 bind. Brief: [`documents-platform-e8-eval.md`](../tasks/documents-platform-e8-eval.md) (feat locked) |
