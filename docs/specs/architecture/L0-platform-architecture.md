...
| 11 | **Architecture Invariants** | ✅ | [`architecture-invariants.md`](architecture-invariants.md) · **INV-16** Decision Priority · **INV-17** Communication Pipeline |
...
| Platform capability maturity (L2, not this freeze) | [`platform-capability-maturity.md`](platform-capability-maturity.md) |
