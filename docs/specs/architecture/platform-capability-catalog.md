...
**Sprint 1–6:** ✅ COMPLETE (backend contour) · **P1 Field Catalog:** ✅ CLOSED · **P2 Builder MVP:** ✅ COMPLETE · **P3 Publish UI / P4 / P5:** **LOCKED** · **Product Track:** [C5 Form Execution](../tasks/forms-platform-c5-form-execution.md) ← active (brief; feat locked) · C1–C4 ✅ · **Rule:** Builder must not invent field types · **Forms Outcome/KPI:** forbidden (compose Acquisition)
...
| **Forbidden** | Candidate / Client / Campaign SoT; Notification delivery / SMTP; Document registry SoT; AI SoT; universal Campaign routing SoT; Forms-owned Outcome/KPI/attribution engines; P3 Publish UI / P4 / P5 · C5 feat without C5 Form Execution brief · Execution without Runtime Model · Runtime importing Builder / Builder importing Runtime |
