...
**Sprint 1–6:** ✅ COMPLETE (backend contour) · **Product Layer:** OPEN ([`../tasks/forms-product-layer-epic.md`](../tasks/forms-product-layer-epic.md)) · **Builder:** **LOCKED** until P1 Field Catalog · **Rule:** Builder must not invent field types · **Forms Outcome/KPI:** forbidden (compose Acquisition)
