...
- **Entity Workspace:** Phase D D1–D9 brief-complete ([Services order cutover](../tasks/entity-workspace-d9-services-order-cutover.md) · [#268](https://github.com/igortatarynovich/HostFlow/pull/268)); **goal-incomplete** vs original Entity Shell ([audit](../gates/platform-scope-completeness-audit.md)). Shell + D2 surfaces + named consumer binds exist; common capabilities / contribution contract do not. Product Track = [Entity Platform Completion](../tasks/entity-platform-completion.md) (feat locked). D2 `documents` catalog unlock = [E2](../tasks/documents-platform-e2-public-contract.md) (consumers unbound; feat locked). Foundation 🔄 ([A2-F7](../gates/platform-governance-review-a2.md)). Do not mark Complete without [Goal Completion Gate](../gates/goal-completion-gate.md).  
- **Documents:** Phase E E2 brief ✅ ([public contract / D2 catalog enable](../tasks/documents-platform-e2-public-contract.md) [#271](https://github.com/igortatarynovich/HostFlow/pull/271)); **feat locked** until Entity Platform Goal Completion. E1 ✅ ([#270](https://github.com/igortatarynovich/HostFlow/pull/270)). Foundation stays 🔄 ([A2-F8](../gates/platform-governance-review-a2.md)). D2 `documents` catalog unlock is E2; D3–D9 unbound. Not OCR / not Hub UI rebuild.
- **Entity Platform Completion:** not a new Catalog platform row. Corrective layer between Shell and modules. Does not move Documents Foundation. Does not claim Entity Foundation ✅ until Goal Completion on the original Shell goal.
...
2. Do **not** mark **Complete** without the platform’s Complete Gate **and** the [Goal Completion Gate](../gates/goal-completion-gate.md) (original problem vs substituted brief). Entity Workspace Complete additionally requires the [capability-based E2E proof](../tasks/entity-platform-completion.md#original-goal--completion-proof), not a UI-component kit.  
...
- Entity Platform Completion: [entity-platform-completion.md](../tasks/entity-platform-completion.md)  
