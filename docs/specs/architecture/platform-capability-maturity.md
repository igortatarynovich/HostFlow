...
- **Entity Workspace:** Phase D D2 ✅ ([composition contract](../tasks/entity-workspace-d2-composition-contract.md); named Composition Gate). D1 ✅ ([#252](https://github.com/igortatarynovich/HostFlow/pull/252)). Shell adapter on tip; chrome SoT path reserved; slot catalog frozen; `documents` reserved empty; Universal runtime not yet. Foundation 🔄 ([A2-F7](../gates/platform-governance-review-a2.md)). Next = D3 cutover brief (locked).  
