...
- **Entity Workspace:** Phase D D4 ✅ ([candidate cutover](../tasks/entity-workspace-d4-candidate-cutover.md) · [#258](https://github.com/igortatarynovich/HostFlow/pull/258)). Next = [D5 Client Cutover](../tasks/entity-workspace-d5-client-cutover.md) (brief; feat locked). Shell adapter on tip; Sales Inquiry + Candidate bound; Client not yet; Shell nav ≠ D2 slots; `documents` reserved empty; Universal runtime not yet. Foundation 🔄 ([A2-F7](../gates/platform-governance-review-a2.md)).  
