...
- **Documents:** Phase E E2 ([public contract / D2 catalog enable](../tasks/documents-platform-e2-public-contract.md); feat locked). E1 ✅ ([#270](https://github.com/igortatarynovich/HostFlow/pull/270)). Foundation stays 🔄 ([A2-F8](../gates/platform-governance-review-a2.md)). D2 `documents` catalog unlock is E2; D3–D9 unbound. Not OCR / not Hub UI rebuild.
