...
- Forms: Sprint 1–6 / Builder MVP exists ([module-scope](../../forms/module-scope.md)); **Phase C C5 Form Execution** ([brief](../tasks/forms-platform-c5-form-execution.md)) ← **active** (brief; feat locked) · C1–C4 ✅ — Foundation not marked ✅ until C3–C6 close.  
