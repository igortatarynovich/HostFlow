...
- **Entity Workspace:** Phase D D3 ✅ ([consumer cutover](../tasks/entity-workspace-d3-consumer-cutover.md); named Cutover Gate; first consumer = Sales Inquiry). D2 ✅ ([#254](https://github.com/igortatarynovich/HostFlow/pull/254)). D1 ✅ ([#252](https://github.com/igortatarynovich/HostFlow/pull/252)). Shell adapter on tip; slot catalog frozen; Sales Inquiry bound; `documents` reserved empty; Universal runtime not yet. Foundation 🔄 ([A2-F7](../gates/platform-governance-review-a2.md)). Next = D4 remaining-consumers brief (locked).  
