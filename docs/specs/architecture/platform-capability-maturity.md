...
- **Entity Workspace:** Phase D D7 brief ([vacancy cutover](../tasks/entity-workspace-d7-vacancy-cutover.md); feat locked). D6 ✅ ([#262](https://github.com/igortatarynovich/HostFlow/pull/262)). Next = D8 brief (locked). Shell adapter on tip; Sales Inquiry + Candidate + Client + Sales Order bound; Vacancy is this consumer; Shell nav ≠ D2 slots; `documents` reserved empty; Universal runtime not yet. Foundation 🔄 ([A2-F7](../gates/platform-governance-review-a2.md)).  
