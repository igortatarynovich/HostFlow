...
**Builder:** `forms.feature_flags.builder_enabled` default **`true`** (P2 MVP). P3 Publish contract sealed ([forms-publish-contract.md](forms-publish-contract.md)). P4 Themes / P5 Analytics remain **LOCKED**.
