...
| **2h ← active** | [Entity Field Composition CL7](../tasks/entity-field-composition-cl7-engine-eval.md): Requirement Engine evaluation. Structured `ready`/`not_ready` + blockers. Not boolean. Not Hub ask generation. Not E8. |
