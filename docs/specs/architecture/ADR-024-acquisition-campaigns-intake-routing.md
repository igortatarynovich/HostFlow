...
**Stage 3D — DONE (Epic P COMPLETE)** (2026-07-18): Outcome attribution + KPI — [`../tasks/acquisition-epic-p-stage-3d.md`](../tasks/acquisition-epic-p-stage-3d.md). E2E: `test_stage_3d_epic_p_contract.py`. **Forms Sprint 1 UNLOCKED**; **Forms Builder LOCKED**.
...
#### Stage 3D Definition of Done — Epic P ✅ COMPLETE (2026-07-18)
...
Base-known CI: [`../tasks/acquisition-epic-p-base-known-ci-failures.md`](../tasks/acquisition-epic-p-base-known-ci-failures.md).
...
1. **Attribution automatic** — via Universal Routing (`acquisition_routing_v1`); no manual links.  
2. **Outcome progress** — `created` · `active` · `completed` · `failed` · `cancelled`.  
3. **Primary KPI** — Flight + Campaign roll-up (Decimal); CPO from completed Outcomes.  
4. **Ownership intact** — no Operations FKs.  
