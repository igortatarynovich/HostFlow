...
| [lead-lifecycle-email-policy.md](lead-lifecycle-email-policy.md) | **ADR-033:** Company-owned lifecycle email policy (RODO + ops); Vacancy sparse override; Control Center; fail-closed + operator signal | Lead, Company, Vacancy, Communication Pipeline | Resolver; Pipeline only (INV-17) |
