# [ARCHIVED] Phase 8 — Поиск, аналитика, NBA v2 (инвентаризация)

**Архивная копия** бывшего `docs/specs/phase-8-roadmap.md`. Инженерные указатели в таблице могут быть полезны при работе с кодом; **архитектурный SSOT** — [`../architecture/hostflow-core-domain-map-v1.md`](../architecture/hostflow-core-domain-map-v1.md).
