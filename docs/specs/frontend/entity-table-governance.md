...
**Status:** canonical (frontend L2) — **blocked** until Phase 0–1 visual sign-off ([`document-row-parity-gate.md`](document-row-parity-gate.md))  
**ADR:** [`ADR-010`](../architecture/ADR-010-unified-resource-list-shell.md) (List Shell zones), [`ADR-015`](../architecture/ADR-015-ui-person-surfaces-and-table-taxonomy.md) (Entity / Compact / Audit taxonomy)  
