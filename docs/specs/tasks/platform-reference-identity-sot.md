...
> **E8-bind unlocked** after **Reference R3 ∧ R4** (scheduled this amendment after DR1 Runtime Gate PASS [#313](https://github.com/igortatarynovich/HostFlow/pull/313)). **E8-eval** unlocks after **Reference R5 ∧ E8-bind Gate**. **E8-bind** is the active **Product** slice. Unlock ≠ schedule for E8-eval.
...
- **E8-bind** scheduled this amendment after DR1 Runtime Gate; **does not** start E8-eval.  
- **E8-eval** unlocks after R5 ∧ E8-bind Gate.  
