...
Unlocks: **E8-eval** (unlock condition **satisfied**; unlock ≠ schedule; brief **not** opened). Later Product via **queue amendment**. Do **not** auto-start E8-eval. Do **not** invent CL8. No named Product successor this amendment.
...
**Unlocks:** E8-eval (unlock condition **satisfied**; not auto-start; brief not opened); later Product via queue amendment  
**Does not:** invent CL8; start E8-eval; mass-bind D3–D9; mint a Hub request table; rewrite Overlay / CL7 / DR1-runtime. No named Product successor this amendment.
