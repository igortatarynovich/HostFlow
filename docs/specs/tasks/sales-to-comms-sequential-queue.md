...
|-------|-------------|------|
| **Product** | **[FP-3](external-intake-forms-publish.md)** after Publish Action Gate **PASS**. Feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**. This stamp does not ship runtime. Not leftover-store deletion. Not Hiring E2E. Not OCR. Do not invent CL8. Do not mark Foundation ✅ | Almost all capacity |
...
| Role | Value |
|------|--------|
| **Active Product** | **[FP-3](external-intake-forms-publish.md)** after Publish Action Gate **PASS**. Feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**. This stamp does not ship runtime. Hiring / min HR remain queued. |
| **Queued Product successor** | **FP-4** Operator publish surface after Public Serve Gate PASS — [brief](external-intake-forms-publish.md). Do not start FP-4 / leftover-store deletion / Hiring / RS-3 in this stamp. Hiring is unlocked by RPM close, **not** scheduled. Not OCR / packages / automation plane / extensions / Billing product / AI. Do not invent CL8. Do not mark Foundation ✅. |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. This stamp opens **FP-3** after Publish Action Gate PASS. Unlock ≠ silent schedule of Hiring. This stamp does not ship runtime. Do not start leftover-store deletion in this stamp.  
...
| **P-FP3** | [FP-3](external-intake-forms-publish.md) Public serve from frozen publication | **Public Serve Gate** **not PASS** — public request → resolve live publication → frozen `form_publication_versions` snapshot → Form Runtime. Feat `feat/forms-publish-fp3-public-serve` open. This stamp does not ship runtime. Not leftover-store deletion. Not Hiring. Not P4 / P5 | Publish Action Gate | FP-4 |

**Now:** Product **[FP-3](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**) after Publish Action Gate **PASS**. Mapping Consumer Cutover Gate **PASS** (`fddadd39`; evidence `92206f40`). **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. This stamp does not ship runtime. **Not** Hiring E2E. **Not** OCR. Do not invent CL8. Do not mark Foundation ✅.
...
Documents:
  ...
  E8-eval ∧ DAG review [#328] → RPM-1 → … → RPM program close → MA-1 → MA-2 → MA-3 → MA-4 → Mapping program close → FP-1 → FP-2 → FP-3   (feat open this stamp)
```

Program horizon of this amendment: **FP-3** (feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**). Publish Action Gate is **PASS**. Forms Publish Contract Gate is **PASS**. Mapping program close is **DONE**. RPM program is **DONE**. Hiring E2E is unlocked, **not** scheduled. Do not invent CL8. Do not auto-start OCR. Do not mark Foundation ✅.

### v1 blocker programs beyond this horizon (briefed, not scheduled)

External Intake / Forms Publish is **no longer in this table** — FP-3 is Active Product (feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**) after Publish Action Gate PASS. A brief is **not** a schedule for the rows below: they exist so the release distance is countable. Activation still requires a queue amendment, one Active Product slice at a time.
...
**FP-3 Public Serve feat opened 2026-09-20.** Branch `feat/forms-publish-fp3-public-serve` from `41be635a`. Serialized-equivalent stays **29–42**. Active Product → **FP-3** (feat open; Public Serve Gate **not PASS**). This stamp does not ship runtime.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: **FP-3**; feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**).  
...
- **Mapping Authority** ← **DONE** — MA-1…MA-4 PASS · Consumer Cutover Gate **PASS** `fddadd39` · program close recorded — [brief](mapping-authority.md). Forms Publish Contract Gate **PASS**. Publish Action Gate **PASS**. Active Product = **[FP-3](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**). Hiring / min HR remain queued.
...
| **46g** | **FP-3** Public serve from frozen publication | [brief](external-intake-forms-publish.md) | after Publish Action Gate; feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS** |
...
**Do not** park later Product on Engineering DONE. Product is FP-3 after Publish Action Gate PASS (feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**).  
**Do not** auto-start Hiring E2E / min HR because FP-3 is named. Hiring is unlocked by RPM close — unlock ≠ schedule. Do not start leftover-store deletion in this stamp. This stamp does not ship runtime.
...
**Do** amend this queue when switching Product Active (this revision: **FP-3**; feat `feat/forms-publish-fp3-public-serve` open; Public Serve Gate **not PASS**).
