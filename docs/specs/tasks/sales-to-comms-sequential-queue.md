...
|-------|-------------|------|
| **Product** | **[HE-3](hiring-workflow-e2e.md)** after Stage Authority Consumption Gate PASS. Eligibility Composition Gate **PASS**. SoT: [hiring-eligibility-composition.md](../architecture/hiring-eligibility-composition.md) (`hiring_eligibility_composition.v1`). Do not start HE-4 / RS-7 / min HR in this PR. Not Mapping/RS-3. Not leftover-store deletion. Not OCR. Do not invent CL8. Do not mark Foundation ✅ | Almost all capacity |
...
| Role | Value |
|------|--------|
| **Active Product** | **[HE-3](hiring-workflow-e2e.md)** after Stage Authority Consumption Gate PASS. Eligibility Composition Gate **PASS**. SoT: [hiring-eligibility-composition.md](../architecture/hiring-eligibility-composition.md) (`hiring_eligibility_composition.v1`). Stage Authority Consumption Gate **PASS**. Hiring Acceptance Contract Gate **PASS**. HE-4 feat locked. min HR remains queued. |
| **Queued Product successor** | **HE-4** Acceptance walk proof (RS-7) after Eligibility Composition Gate PASS — [brief](hiring-workflow-e2e.md). Do not start HE-4 / RS-7 / min HR / leftover-store deletion / RS-3 in this composition PR. Not OCR / packages / automation plane / extensions / Billing product / AI. Do not invent CL8. Do not mark Foundation ✅. |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. Active Product is **HE-3** after Stage Authority Consumption Gate PASS. Eligibility Composition Gate **PASS**. Unlock ≠ silent schedule of HE-4 / min HR. Do not start RS-7. Do not start leftover-store deletion. Do not convert FP-5 PASS into Release Acceptance PASS.  
...
Product:
  CL0 → CL1 → LI-1 → DR1-contract → CL2 → CL3 → CL4 → CL5 → CL6 → CL7 → Vacancy Overlay Contract → DR1-runtime → E8-bind → E8-eval → RPM-1 → RPM-2 → RPM-3A → RPM-3B → rpm-cutover → RPM program close → MA-1 → MA-2 → MA-3 → MA-4 → Mapping program close → FP-1 → FP-2 → FP-3 → FP-4 → FP-5 → External Intake program close → HE-1 → HE-2 → HE-3
...
Documents:
  ...
  E8-eval ∧ DAG review [#328] → RPM-1 → … → RPM program close → MA-1 → MA-2 → MA-3 → MA-4 → Mapping program close → FP-1 → FP-2 → FP-3 → FP-4 → FP-5 → External Intake program close → HE-1 → HE-2 → HE-3   (this amendment)
```

Program horizon of this amendment: **HE-3** (Eligibility Composition). Stage Authority Consumption Gate is **PASS**. Hiring Acceptance Contract Gate is **PASS**. External Intake program close is **DONE**. Mapping program close is **DONE**. RPM program is **DONE**. min HR remains unlocked by Hiring close, **not** scheduled. Do not invent CL8. Do not auto-start OCR. Do not mark Foundation ✅.

### v1 blocker programs beyond this horizon (briefed, not scheduled)

Hiring workflow E2E is **no longer in this table** — HE-3 is Active Product (Eligibility Composition Gate **PASS**; HE-4 feat locked). A brief is **not** a schedule for the rows below: they exist so the release distance is countable. Activation still requires a queue amendment, one Active Product slice at a time.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: HE-3; Eligibility Composition Gate **PASS**; HE-4 feat locked).  
...
| **46m** | **HE-3** Eligibility composition | [brief](hiring-workflow-e2e.md) · [composition SoT](../architecture/hiring-eligibility-composition.md) | after Stage Authority Consumption Gate; Eligibility Composition Gate **PASS**; HE-4 feat locked |
...
**Active (Product):** **[HE-3](hiring-workflow-e2e.md)** after Stage Authority Consumption Gate PASS. Eligibility Composition Gate **PASS**. SoT: [hiring-eligibility-composition.md](../architecture/hiring-eligibility-composition.md) (`hiring_eligibility_composition.v1`). Stage Authority Consumption Gate **PASS**. Hiring Acceptance Contract Gate **PASS**. External Intake Acceptance Gate **PASS** `4f454556`. Mapping Consumer Cutover Gate **PASS** `fddadd39`; evidence `92206f40`. E8-eval ✅ [#324](https://github.com/igortatarynovich/HostFlow/pull/324) / `19c95ef6`. **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. **Not** Mapping/RS-3. **Not** min HR. Do not invent CL8. Do not mark Foundation ✅. E8-bind ✅ [#321](https://github.com/igortatarynovich/HostFlow/pull/321). DR1-runtime ✅ [#313](https://github.com/igortatarynovich/HostFlow/pull/313). Overlay ✅ [#311](https://github.com/igortatarynovich/HostFlow/pull/311). E7 ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287). Foundation stays 🔄.  
...
**Do not** park later Product on Engineering DONE. Product is **[HE-3](hiring-workflow-e2e.md)** after Stage Authority Consumption Gate PASS. Eligibility Composition Gate **PASS**. Hiring Acceptance Contract Gate **PASS**.  
**Do not** auto-start min HR because Hiring is Active. Unlock ≠ schedule. Do not start HE-4 / RS-7 in this PR. Do not start leftover-store deletion in this stamp. Do not mix Mapping / RS-3 / embed snippet in this stamp. Do not convert FP-5 PASS into Release Acceptance PASS.
...
**Do** amend this queue when switching Product Active (this revision: Active Product = **HE-3**; Eligibility Composition Gate **PASS**; HE-4 feat locked).
