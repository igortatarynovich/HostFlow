...
| **P-4** | **Acquisition Stage 4** Flight Runtime | `feat/acquisition-stage-4-pr3-runtime-read` | **PR-1 ✅ #136** · **PR-2 #148** · **PR-3 active** — Runtime Read + Live Intake Monitor — [stage-4](acquisition-stage-4-flight-runtime.md) |
