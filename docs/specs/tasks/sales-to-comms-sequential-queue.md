...
|-------|-------------|------|
| **Product** | **E8-eval** — [brief](documents-platform-e8-eval.md); required / optional / applicability from R5 merge; not OCR; not CL8; not mass D3–D9 bind | Almost all capacity |
...
| Role | Value |
|------|--------|
| **Active Product** | **E8-eval** — [Documents Platform E8-eval](documents-platform-e8-eval.md) (brief; feat locked) |
| **Queued Product successor** | later Product via queue amendment. Not OCR auto-start. Do not invent CL8. |
...
| **Phase E** | **E7 = DONE**. **E8-bind = DONE** (Gate PASS [#321] / `8246421f`). **E8-eval = Active** (this amendment) |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. After E8-bind Gate PASS, this amendment **schedules E8-eval** (unlock ≠ silent schedule).  
...
| **E8-eval** | **Reference R5 Gate ∧ E8-bind Gate** | Product Track; **scheduled this amendment** after E8-bind Gate PASS [#321](https://github.com/igortatarynovich/HostFlow/pull/321) / `8246421f` and queue amendment [#322](https://github.com/igortatarynovich/HostFlow/pull/322). Unlock was not auto-start; this amendment is the schedule | required/optional; applicability; candidate requirement evaluation from R5 merge. Consume existing packs as policy input. **Not** OCR product; **not** a packages Hub table |

E8-eval brief opened this amendment. Unlock does not schedule OCR / CL8 / Foundation.
...
Documents:
  ...
  r5 ∧ E8-bind → E8-eval   Active (this amendment)
```

Program horizon of this amendment: **E8-eval**. After E8-eval Gate, a new queue amendment names the next Product slice. No silent successor. Do not invent CL8. Do not auto-start OCR.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: E8-eval).  
...
- **Documents E8-eval** ← **active** (brief; feat locked) — [brief](documents-platform-e8-eval.md); required / optional / applicability from R5 merge. Not OCR. Not CL8. Not mass D3–D9 bind.
...
| **45b** | **E8-eval** Required-doc evaluation | [brief](documents-platform-e8-eval.md) | after **E8-bind Gate**; brief; feat locked; not OCR; not CL8; not mass D3–D9 bind |
...
**Active (Product):** [E8-eval](documents-platform-e8-eval.md) (brief; feat locked). **Next Product after E8-eval Gate:** later Product via queue amendment. **Not** OCR auto-start. Do not invent CL8. E8-bind ✅ [#321](https://github.com/igortatarynovich/HostFlow/pull/321). DR1-runtime ✅ [#313](https://github.com/igortatarynovich/HostFlow/pull/313). Overlay ✅ [#311](https://github.com/igortatarynovich/HostFlow/pull/311). E7 ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287). Foundation stays 🔄.  
...
**Do not** auto-start OCR / packages product / CL8 after E8-eval Gate.  
**Do not** park later Product on Engineering DONE (no successor this amendment). E8-eval is Active Product.  
...
**Do** amend this queue when switching Product Active (this revision: live = E8-eval, brief; feat locked).
