...
- Communication Capability Epic C2 — **active** (slice **C2.3** — implementation complete, merge gate failed; C2.1–C2.2 ✅; do not start C2.4)  
...
| **7c** | **C2.3** Campaign Orchestrator | PR #121–#126 — implementation complete, merge gate failed | Audience + plan → Intent (no render/send/Thread) |
...
**Active:** **C2.3 Campaign Orchestrator** — implementation complete, merge gate failed · epic [C2](epic-c2-communication-campaigns.md) · [c2-3-campaign-orchestrator.md](c2-3-campaign-orchestrator.md). Do **not** start C2.4 until PR-5 (#125) and PR-6 (#126) merge.  
...
**Close-out:** C2.1 ✅ → C2.2 ✅ → C2.3 (merge pending) → C2.4 → [Epic C Complete Gate](../gates/epic-c-complete-gate.md) → Governance → Stage 3.  
...
## 5b. Epic C2 — Communication Capability Epic ← **active (C2.3 merge gate)**

**Epic:** [epic-c2-communication-campaigns.md](epic-c2-communication-campaigns.md)  
**Current slice:** [c2-3-campaign-orchestrator.md](c2-3-campaign-orchestrator.md) — implementation complete, merge gate failed (C2.1–C2.2 ✅; do not start C2.4)
