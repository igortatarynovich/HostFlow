...
- **Acquisition UI Cutover** ← **Product Track = C-4** — [cutover](acquisition-ui-cutover.md) · [C-4 brief](acquisition-ui-cutover-c4-test-lead-field-discovery.md) (C-1…C-3 ✅; **C-7 PASS closes migration**; then product evolution)  
...
| **P-4b** | **Acquisition UI Cutover** | C-1 ✅ #157 · C-2 ✅ #158 · C-3 ✅ #160 · **C-4 ACTIVE** | **ACTIVE** — [C-4 test lead / discovery](acquisition-ui-cutover-c4-test-lead-field-discovery.md); then C-5 mapping; **C-6** Forms; **C-7** Searches decommission — [cutover](acquisition-ui-cutover.md) |
...
**Active (Product):** [C-4 test lead / discovery](acquisition-ui-cutover-c4-test-lead-field-discovery.md) · [cutover](acquisition-ui-cutover.md) (C-1…C-3 ✅; Stage 5 PR-2 paused).  
