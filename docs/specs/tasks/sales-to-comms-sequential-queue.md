...
|-------|-------------|------|
| **Product** | **[RPM-3B Consumer parity](requirement-policy-management.md)** after RPM-3A Gate **PASS**. Feat locked this PR. Then Consumer Cutover Gate. Not Mapping. Not Hiring E2E. Not OCR. Do not invent CL8. Do not mark Foundation ✅ | Almost all capacity |
...
| Role | Value |
|------|--------|
| **Active Product** | **[RPM-3B Consumer parity](requirement-policy-management.md)** after RPM-3A Gate **PASS**. Feat locked this PR. Mapping / Hiring remain closed. |
| **Queued Product successor** | **Consumer Cutover Gate** after RPM-3B Gate PASS — [brief](requirement-policy-management.md). Mapping remains startable **after** RPM program close (not auto-scheduled). The four remaining v1 blockers are **briefed but unscheduled** — see § v1 blocker programs beyond this horizon. Not OCR / packages / automation plane / extensions / Billing product / AI. Do not invent CL8. Do not mark Foundation ✅. |
...
| **Phase E** | **E7 = DONE**. **E8-bind = DONE** (Gate PASS [#321] / `8246421f`). **E8-eval = DONE** (Gate PASS [#324] / `19c95ef6`). **RPM-1 = DONE** (Authority Gate PASS). **RPM-2 = DONE** (Operator Gate PASS [#342]). **RPM-3A = DONE** (Parallel Authority Retirement Gate PASS). **Product = RPM-3B** (not a Phase E leftover) |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. This amendment names **RPM-3B** after RPM-3A Gate PASS. Unlock ≠ silent schedule of Mapping / Hiring. Do not start RPM-3B feat in this 3A PR.  
...
| **P-RPM3B** | [RPM-3B](requirement-policy-management.md) Consumer parity | **Requirement Policy Consumer Parity Gate** — remaining consumers’ policy answer matches R5 required-set (base / require X / remove X). Feat locked this PR | **Requirement Policy Parallel Authority Retirement Gate** | Consumer Cutover Gate |
...
**Now:** Product **RPM-3B** (consumer parity; feat locked this PR) after RPM-3A Gate **PASS**. **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** Mapping auto-start. **Not** OCR. Do not invent CL8. Do not mark Foundation ✅.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: RPM-3B; consumer parity; feat locked this PR).  
...
- **Requirement Policy Management** ← **RPM-1 PASS** · **RPM-2 PASS** [#342](https://github.com/igortatarynovich/HostFlow/pull/342) / `5196ee64` · **RPM-3A PASS** (Parallel Authority Retirement Gate). Active **RPM-3B** (consumer parity; feat locked this PR) — [brief](requirement-policy-management.md). Mapping not auto-scheduled. Not Hiring E2E. Not CL8.
...
| **45f** | **RPM-3B** Consumer parity | [brief](requirement-policy-management.md) | after RPM-3A Gate; Active; feat locked this PR; then Consumer Cutover Gate |
...
**Do not** park later Product on Engineering DONE. Product is **RPM-3B** after RPM-3A Gate PASS (feat locked this PR).  
...
**Do** amend this queue when switching Product Active (this revision: live = **RPM-3B**; consumer parity; feat locked this PR; RPM-3A Gate PASS).

---

## 8. History

- 2026-09-03: **RPM-3A Parallel Authority Retirement feat PASS.** 410 on `document_policies` and leftover ruleset writes; P3B `document_required` inert; `field_required` kept. Active Product → **RPM-3B** (consumer parity; feat locked this PR). Mapping / Hiring E2E not auto-scheduled. Not CL8. Foundation stays 🔄.
