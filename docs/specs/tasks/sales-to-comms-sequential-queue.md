...
|-------|-------------|------|
| **Product** | **Documents Platform E7** Document requests — [brief](documents-platform-e7-document-requests.md); feat; Hub outstanding-ask SoT; D4/D8 stay; D3 / D5–D7 / D9 stay unbound | Almost all capacity |
...
- **Documents Platform E7 — Document Requests** ← **active** (feat) — [brief](documents-platform-e7-document-requests.md); Hub outstanding-ask SoT; D4/D8 stay; D3 / D5–D7 / D9 stay unbound; not mass bind / not packages / not OCR / not Foundation ✅  
...
| **35** | **Documents Platform E7** Document requests | `docs/…` | **active** (feat) — Hub outstanding ask; not mass D3–D9 |
...
**Active (Product):** Documents Platform E7 — [Document Requests](documents-platform-e7-document-requests.md) (feat). Hub outstanding-ask SoT. E6 ✅ [#285](https://github.com/igortatarynovich/HostFlow/pull/285) (named Document Expiry Gate). E5 ✅ [#282](https://github.com/igortatarynovich/HostFlow/pull/282) (named Candidate Storage Bridge Gate). E4 ✅. E3 ✅. E2 ✅. WCP [COMPLETE](../gates/workspace-capability-platform-complete.md). E1 ✅. D4/D8 stay bound. D3 / D5–D7 / D9 stay unbound. G4 stays Recruitment Application. Foundation stays 🔄. E8+ locked until this feat.  
...
### Documents Platform E7 — Document Requests ← **active** (feat)
...
**Do** amend this queue when switching Product Active (this revision: live = Documents Platform E7 feat).
