...
|-------|-------------|------|
| **Product** | **[FP-2](external-intake-forms-publish.md)** after Forms Publish Contract Gate **PASS**. Feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**. Do not ship FP-2 runtime in this stamp. Not leftover-store deletion. Not Hiring E2E. Not OCR. Do not invent CL8. Do not mark Foundation ✅ | Almost all capacity |
...
| Role | Value |
|------|--------|
| **Active Product** | **[FP-2](external-intake-forms-publish.md)** after Forms Publish Contract Gate **PASS**. Feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**. Do not ship FP-2 runtime in this stamp. Hiring / min HR remain queued. |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. This stamp opens **FP-2** after Forms Publish Contract Gate PASS. Unlock ≠ silent schedule of Hiring. Do not ship FP-2 runtime in this stamp. Do not start leftover-store deletion in this stamp.  
...
| **P-FP2** | [FP-2](external-intake-forms-publish.md) Publish action runtime | **Publish Action Gate** **not PASS** — authenticated product route → `commit_publish`; leftover version bumps retire; republish idempotent per identity. Feat `feat/forms-publish-fp2-publish-action` open. This stamp does not ship runtime. Not FP-3. Not leftover-store deletion. Not Hiring. Not P4 / P5 | Forms Publish Contract Gate | FP-3 |

**Now:** Product **[FP-2](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**) after Forms Publish Contract Gate **PASS**. Mapping Consumer Cutover Gate **PASS** (`fddadd39`; evidence `92206f40`). **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. Do not ship FP-2 runtime in this stamp. **Not** Hiring E2E. **Not** OCR. Do not invent CL8. Do not mark Foundation ✅.
...
Program horizon of this amendment: **FP-2** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**). Forms Publish Contract Gate is **PASS**. Mapping program close is **DONE**. RPM program is **DONE**. Hiring E2E is unlocked, **not** scheduled. Do not invent CL8. Do not auto-start OCR. Do not mark Foundation ✅.

### v1 blocker programs beyond this horizon (briefed, not scheduled)

External Intake / Forms Publish is **no longer in this table** — FP-2 is Active Product (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**) after Forms Publish Contract Gate PASS. A brief is **not** a schedule for the rows below: they exist so the release distance is countable. Activation still requires a queue amendment, one Active Product slice at a time.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: **FP-2**; feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**).  
...
- **Mapping Authority** ← **DONE** — MA-1…MA-4 PASS · Consumer Cutover Gate **PASS** `fddadd39` · program close recorded — [brief](mapping-authority.md). Forms Publish Contract Gate **PASS**. Active Product = **[FP-2](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**). Hiring / min HR remain queued.
...
| **46f** | **FP-2** Publish action runtime | [brief](external-intake-forms-publish.md) | after Forms Publish Contract Gate; feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS** |
...
**Active (Product):** **[FP-2](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**) after Forms Publish Contract Gate **PASS**. Mapping Consumer Cutover Gate **PASS** `fddadd39`; evidence `92206f40`. E8-eval ✅ [#324](https://github.com/igortatarynovich/HostFlow/pull/324) / `19c95ef6`. **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. Do not ship FP-2 runtime in this stamp. **Not** Hiring E2E. Do not invent CL8. Do not mark Foundation ✅. E8-bind ✅ [#321](https://github.com/igortatarynovich/HostFlow/pull/321). DR1-runtime ✅ [#313](https://github.com/igortatarynovich/HostFlow/pull/313). Overlay ✅ [#311](https://github.com/igortatarynovich/HostFlow/pull/311). E7 ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287). Foundation stays 🔄.  
...
**Do not** park later Product on Engineering DONE. Product is FP-2 after Forms Publish Contract Gate PASS (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**).  
**Do not** auto-start Hiring E2E / min HR because FP-2 is named. Hiring is unlocked by RPM close — unlock ≠ schedule. Do not start leftover-store deletion in this stamp. Do not ship FP-2 runtime in this stamp.
...
**Do** amend this queue when switching Product Active (this revision: **FP-2**; feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**).
