...
| **P-4b** | **Acquisition UI Cutover** | C-1 ✅ #157 · C-2 ✅ #158 · next C-3…C-7 | **ACTIVE** — **C-3 Sources foundation**; then C-4–C-5 mapping; **C-6** Forms; **C-7** Searches decommission — [cutover](acquisition-ui-cutover.md) |
...
**Active (Product):** [acquisition-ui-cutover.md](acquisition-ui-cutover.md) (Stage 4 runtime DONE; product/UI cutover NOT DONE; Stage 5 PR-2 paused).  
