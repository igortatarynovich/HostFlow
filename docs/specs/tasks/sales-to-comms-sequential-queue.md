...
|-------|-------------|------|
| **Product** | **Entity Workspace D8** HR Employee Cutover — [brief](entity-workspace-d8-hr-employee-cutover.md); feat locked; Services `/app/orders` out | Almost all capacity |
...
- **Entity Workspace D8 — HR Employee Cutover** ← **active** (brief; feat locked) — [brief](entity-workspace-d8-hr-employee-cutover.md); Services `/app/orders` out  
...
| **26** | **Entity Workspace D8** HR employee cutover | `docs/entity-workspace-d8-hr-employee-cutover` then `feat/…` | **active** (brief; feat locked) — [brief](entity-workspace-d8-hr-employee-cutover.md) |
...
**Active (Product):** Entity Workspace D8 — [HR Employee Cutover](entity-workspace-d8-hr-employee-cutover.md) (brief; feat locked). Next = D9 brief (locked).  
...
### Entity Workspace D8 — HR employee cutover ← **active** (brief; feat locked)
