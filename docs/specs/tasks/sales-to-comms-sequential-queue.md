...
- **Acquisition UI Cutover** ← **Product Track = C-7** — [cutover](acquisition-ui-cutover.md) (C-1 ✅ · C-2 ✅ **with constraints** · C-3 ✅ **with constraints** · C-3.1 ✅ · C-4 ✅ · C-5 ✅ · **C-6 ✅**; **C-7 PASS closes migration**; then product evolution)  
...
**Active (Product):** [C-7 Подборы decommission](acquisition-ui-cutover-c7-searches-decommission.md) · [cutover](acquisition-ui-cutover.md) (C-6 Forms DONE; Stage 5 PR-2 paused until C-7 PASS).
