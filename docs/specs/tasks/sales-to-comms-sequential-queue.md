...
|-------|-------------|------|
| **Product** | **Documents Platform E3** First consumer bind + Document Link SoT — [brief](documents-platform-e3-first-consumer-bind.md); feat; first consumer = HR employee; D3–D7 / D9 stay unbound | Almost all capacity |
...
- **Documents Platform E3 — First Consumer Bind + Document Link SoT** ← **active** (feat) — [brief](documents-platform-e3-first-consumer-bind.md); first consumer = HR employee; D3–D7 / D9 stay unbound; not OCR / not G4 / not Foundation ✅  
- **Documents Platform E4+** Candidate Document Link bind / remaining consumers / lifecycle ← **locked until E3 feat**  
...
| **31** | **Documents Platform E3** First consumer bind + Document Link SoT | `docs/…` ✅ [#277](https://github.com/igortatarynovich/HostFlow/pull/277) · `feat/…` | **active** (feat) — [brief](documents-platform-e3-first-consumer-bind.md); named First Consumer Bind Gate; first consumer = HR employee |
| **32** | **Documents Platform E4+** Candidate Document Link / remaining consumers / lifecycle | locked | until E3 feat |

**C0–C2.3** ✅. **C2.4 frozen.** **Epic C — complete.** **A2 — PASS_WITH_CONSTRAINTS.** Forms Foundation ✅. D1–D9 brief-complete / goal-incomplete.  
**Active (Product):** Documents Platform E3 — [First Consumer Bind + Document Link SoT](documents-platform-e3-first-consumer-bind.md) (feat; named First Consumer Bind Gate). First consumer = HR employee. E2 ✅. WCP [COMPLETE](../gates/workspace-capability-platform-complete.md). E1 ✅. D3–D7 / D9 stay unbound. G4 stays Recruitment Application. Foundation stays 🔄. E4+ locked until this feat.  
...
### Documents Platform E3 — First Consumer Bind + Document Link SoT ← **active** (feat)

[documents-platform-e3-first-consumer-bind.md](documents-platform-e3-first-consumer-bind.md). One named consumer (HR employee / D8) receives documents via D2 `documents` surface + `documents.hub_adapter_v1` + `document_entity_links`. Not Candidate via `candidate_id`. Not G4. Not OCR / e-sign / packages. D3–D7 / D9 stay unbound. Foundation stays 🔄.
...
**Do not** treat Shell/chrome or D1–D9 named gates as original Entity Platform done; **do not** mix E3 into an E2/WCP PR; **do not** multiply new entity/application screens, rails, or D10 cutovers; **do not** fold Application Workspace into Entity Workspace; **do not** treat E2 catalog unlock as mass D3–D9 `documents` bind; **do not** treat Shell `documents` nav, Vacancy docs section, HR dossier, or Services billing tab as the D2 `documents` slot; **do not** treat Recruitment Application G4 as the Documents proof; **do not** start OCR / e-sign / packages / Forms P3–P5 / Billing / AI; **do not** drop `documents.candidate_id` in E3; **do not** patch Recruitment RODO/comments as the platform fix; **do not** mix ListWorkspace into this close-out.  
...
**Do** amend this queue when switching Product Active (this revision: live = Documents Platform E3 feat).
