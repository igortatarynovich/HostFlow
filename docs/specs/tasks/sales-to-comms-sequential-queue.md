...
| **P-4** | **Acquisition Stage 4** Flight Runtime | `feat/acquisition-stage-4-pr2-crud-hardening` | **PR-1 ✅ #136** · **PR-2 active** — Campaign/Endpoint CRUD hardening — [stage-4](acquisition-stage-4-flight-runtime.md) |
