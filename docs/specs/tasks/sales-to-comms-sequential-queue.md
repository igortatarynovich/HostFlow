...
|-------|-------------|------|
| **Product** | **Entity Field Composition CL1** Candidate inventory — [brief](entity-field-composition-cl1-inventory.md); feat locked; docs only; not CL2 / not E8 / not Forms P3 | Almost all capacity |
...
- **Entity Field Composition CL0 — Contract Seal** ← ✅ [#289](https://github.com/igortatarynovich/HostFlow/pull/289) — [brief](entity-field-composition-cl0-contract-seal.md); Page Type + two builder modes; Profile = role manifest; four requirement kinds; Engine not boolean; `transition`/`handoff` off Profile field  
- **Entity Field Composition CL1 — Candidate Inventory** ← **active** (brief; feat locked) — [brief](entity-field-composition-cl1-inventory.md); classify live Candidate vs CL0 kinds; not runtime; not E8  
- **Documents Platform E8+** Remaining consumers / later lifecycle ← **locked** (E7 ✅; Product Track = CL1; do not start E8 in this slice)  
...
| **36** | **Entity Field Composition CL0** Contract seal | `docs/…` ✅ [#289](https://github.com/igortatarynovich/HostFlow/pull/289) | ✅ brief seal · merge `209cc949` |
| **37** | **Entity Field Composition CL1** Candidate inventory | `docs/…` | **active** (brief; feat locked) — classify live Candidate vs CL0 kinds |
| **38** | **Documents Platform E8+** Remaining consumers / later lifecycle | locked | Product Track = CL1; do not start E8 |

**C0–C2.3** ✅. **C2.4 frozen.** **Epic C — complete.** **A2 — PASS_WITH_CONSTRAINTS.** Forms Foundation ✅. D1–D9 brief-complete / goal-incomplete.  
**Active (Product):** Entity Field Composition CL1 — [Candidate inventory](entity-field-composition-cl1-inventory.md) (brief; feat locked). CL0 ✅ [#289](https://github.com/igortatarynovich/HostFlow/pull/289). E7 ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287) (named Document Requests Gate). E6 ✅ [#285](https://github.com/igortatarynovich/HostFlow/pull/285). E5 ✅ [#282](https://github.com/igortatarynovich/HostFlow/pull/282). E4 ✅. E3 ✅. E2 ✅. WCP [COMPLETE](../gates/workspace-capability-platform-complete.md). E1 ✅. D4/D8 stay bound. D3 / D5–D7 / D9 stay unbound. G4 stays Recruitment Application. Foundation stays 🔄. E8+ locked.  
...
**Do** amend this queue when switching Product Active (this revision: live = Entity Field Composition CL1 brief).

---

## 8. History

- 2026-08-23: CL1 brief opened — Candidate composition inventory. Product Track → [Entity Field Composition CL1](entity-field-composition-cl1-inventory.md) (feat locked). CL0 ✅ [#289](https://github.com/igortatarynovich/HostFlow/pull/289) (`209cc949`). E8 stays locked. Foundation stays 🔄.
