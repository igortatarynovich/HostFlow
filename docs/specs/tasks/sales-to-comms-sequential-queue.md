...
|-------|-------------|------|
| **Product** | **Stage 5 PR-2** (optimization explainability / ack-dismiss) | Almost all capacity |
...
| **P-5** | **Acquisition Stage 5** Optimization | active | **PR-1 DONE** (#153) · **PR-2 IN PROGRESS** — [stage-5](acquisition-stage-5-optimization.md) |
