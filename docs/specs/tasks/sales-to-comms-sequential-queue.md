...
> **2026-08-15 strategy:** Epic C + A2 **PASS_WITH_CONSTRAINTS**. Forms C1–C6 ✅ / Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Entity Workspace D1 ✅ · D2 ✅ · D3 ✅ ([#255](https://github.com/igortatarynovich/HostFlow/pull/255)/[#256](https://github.com/igortatarynovich/HostFlow/pull/256)). **Product Track:** [Entity Workspace D4 — Candidate Cutover](entity-workspace-d4-candidate-cutover.md) (brief; feat locked). Shell `documents` nav ≠ D2 `documents` enable. **Engineering Track** = legacy pytest / Catalog Notifications↔Communication RFC / Kit Baseline chrome sync.  
...
|-------|-------------|------|
| **Product** | **Entity Workspace D4** Candidate Cutover — [brief](entity-workspace-d4-candidate-cutover.md); feat locked; Shell nav ≠ D2 slots | Almost all capacity |
...
- **Entity Workspace D4 — Candidate Cutover** ← **active** (brief; feat locked) — [brief](entity-workspace-d4-candidate-cutover.md); Shell `documents` nav ≠ D2 `documents` enable; HR/Vacancy out  
...
| **22** | **Entity Workspace D4** Candidate cutover | `docs/entity-workspace-d4-candidate-cutover` then `feat/…` | **active** (brief; feat locked) — [brief](entity-workspace-d4-candidate-cutover.md) |

**C0–C2.3** ✅. **C2.4 frozen.** **Epic C — complete.** **A2 — PASS_WITH_CONSTRAINTS.** Forms Foundation ✅. D1 ✅. D2 ✅. D3 ✅.  
**Active (Product):** Entity Workspace D4 — [Candidate Cutover](entity-workspace-d4-candidate-cutover.md) (brief; feat locked).  
...
### Entity Workspace D4 — Candidate cutover ← **active** (brief; feat locked)
...
**Do not** treat Shell/chrome as Phase D Universal done; **do not** enable D2 Documents slot before Phase E; **do not** start D4 feat or Forms P3–P5 before this D4 brief merges; **do not** treat Shell `documents` nav as D2 `documents` enable; **do not** cut over HR/Vacancy in D4.  
**Do** amend this queue when switching Product Active (this revision: live = Entity Workspace D4 brief; feat locked).
