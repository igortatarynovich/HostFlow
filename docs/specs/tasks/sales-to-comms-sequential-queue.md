...
|-------|-------------|------|
| **Product** | **Source Diagnostics PR8** (replay; PR1–7 ✅ #206 · Stage 5 PR-2 ✅ #203) | Almost all capacity |
...
- **Source Diagnostics** ← **ACTIVE Product Track** — PR1–PR7 ✅ (#196–#206) · **PR8 replay** — [brief](acquisition-source-diagnostics.md)  
...
**Active (Product):** **Source Diagnostics PR8** replay submission (PR1–7 ✅ [#196](https://github.com/igortatarynovich/HostFlow/pull/196)–[#206](https://github.com/igortatarynovich/HostFlow/pull/206)). Stage 5 PR-2 ✅ [#203](https://github.com/igortatarynovich/HostFlow/pull/203).  
