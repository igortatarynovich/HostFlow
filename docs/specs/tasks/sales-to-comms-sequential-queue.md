...
|-------|-------------|------|
| **Product** | **[FP-3](external-intake-forms-publish.md)** after Publish Action Gate **PASS**. Feat locked. Do not start FP-3 in this stamp. Not leftover-store deletion. Not Hiring E2E. Not OCR. Do not invent CL8. Do not mark Foundation ✅ | Almost all capacity |
...
1. **One Active Product slice**, **or Product DONE with no named successor until amendment**. This stamp names **FP-3** after Publish Action Gate PASS. Unlock ≠ silent schedule of Hiring. Do not start FP-3 in this stamp. Do not start leftover-store deletion in this stamp.  
...
| **P-FP3** | [FP-3](external-intake-forms-publish.md) Public serve from frozen publication | **Public Serve Gate** **not PASS** — public form served from the frozen snapshot. Feat locked. Do not start FP-3 in this stamp. Not leftover-store deletion. Not Hiring. Not P4 / P5 | Publish Action Gate | FP-4 |

**Now:** Product **[FP-3](external-intake-forms-publish.md)** (feat locked; Public Serve Gate **not PASS**) after Publish Action Gate **PASS**. Mapping Consumer Cutover Gate **PASS** (`fddadd39`; evidence `92206f40`). **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. Do not start FP-3 in this stamp. **Not** Hiring E2E. **Not** OCR. Do not invent CL8. Do not mark Foundation ✅.
...
Documents:
  ...
  E8-eval ∧ DAG review [#328] → RPM-1 → … → RPM program close → MA-1 → MA-2 → MA-3 → MA-4 → Mapping program close → FP-1 → FP-2   (feat open this stamp)
```

Program horizon of this amendment: **FP-3** (feat locked; Public Serve Gate **not PASS**). Publish Action Gate is **PASS**. Forms Publish Contract Gate is **PASS**. Mapping program close is **DONE**. RPM program is **DONE**. Hiring E2E is unlocked, **not** scheduled. Do not invent CL8. Do not auto-start OCR. Do not mark Foundation ✅.

### v1 blocker programs beyond this horizon (briefed, not scheduled)

External Intake / Forms Publish is **no longer in this table** — FP-3 is Active Product (feat locked; Public Serve Gate **not PASS**) after Publish Action Gate PASS. A brief is **not** a schedule for the rows below: they exist so the release distance is countable. Activation still requires a queue amendment, one Active Product slice at a time.
...
1. Exactly one **Active Product** slice, **or Product DONE with no named successor until amendment** (now: **FP-3**; feat locked; Public Serve Gate **not PASS**).  
...
| **46g** | **FP-3** Public serve from frozen publication | [brief](external-intake-forms-publish.md) | after Publish Action Gate; feat locked; Public Serve Gate **not PASS** |
...
**Active (Product):** **[FP-3](external-intake-forms-publish.md)** (feat locked; Public Serve Gate **not PASS**) after Publish Action Gate **PASS**. Mapping Consumer Cutover Gate **PASS** `fddadd39`; evidence `92206f40`. E8-eval ✅ [#324](https://github.com/igortatarynovich/HostFlow/pull/324) / `19c95ef6`. **v1 scope:** [Release Goal](../gates/hostflow-v1-release-goal.md). **Not** leftover-store deletion. Do not start FP-3 in this stamp. **Not** Hiring E2E. Do not invent CL8. Do not mark Foundation ✅. E8-bind ✅ [#321](https://github.com/igortatarynovich/HostFlow/pull/321). DR1-runtime ✅ [#313](https://github.com/igortatarynovich/HostFlow/pull/313). Overlay ✅ [#311](https://github.com/igortatarynovich/HostFlow/pull/311). E7 ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287). Foundation stays 🔄.  
...
**Do not** park later Product on Engineering DONE. Product is FP-3 after Publish Action Gate PASS (feat locked; Public Serve Gate **not PASS**).  
**Do not** auto-start Hiring E2E / min HR because FP-3 is named. Hiring is unlocked by RPM close — unlock ≠ schedule. Do not start leftover-store deletion in this stamp. Do not start FP-3 in this stamp.
...
**Do** amend this queue when switching Product Active (this revision: **FP-3**; feat locked; Public Serve Gate **not PASS**).
