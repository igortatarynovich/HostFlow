...
> **2026-07-21 strategy:** Communication foundation is mature enough. **Product Track** = Flights / Acquisition (Stage **3E**). **Engineering Track** = legacy full-repo pytest / CI debt — must not stop Product unless clean deploy or a Product PR introduces breakage.  
...
|-------|-------------|------|
| **Product** | [Acquisition Stage 3E — Flight Timeline](acquisition-stage-3e-flight-timeline.md) | Almost all capacity |
...
- **Acquisition Stage 3E / Flight Runtime** ← **Product Track active**  
...
| **P-3E** | **Acquisition Stage 3E** Flight Timeline | `feat/acquisition-stage-3e-flight-timeline` (**Product current**) | Timeline + automation events; Flight Runtime operable |
...
**Active (Product):** [acquisition-stage-3e-flight-timeline.md](acquisition-stage-3e-flight-timeline.md).  
**Engineering:** legacy full-repo pytest does **not** stop Flights unless Product PR breaks deploy/Alembic/new-module bootstrap.
...
**Product active elsewhere:** [Stage 3E Flight Timeline](acquisition-stage-3e-flight-timeline.md). C2.3 merge + C2.4 = Engineering / later close-out.
...
- 2026-07-21 (rev. tracks): **Product Track** = Acquisition Stage 3E / Flight Runtime; **Engineering Track** = legacy pytest/CI (#127/#128 deferred); C2.4 frozen; do not block Flights on 657 base-known fails.  
