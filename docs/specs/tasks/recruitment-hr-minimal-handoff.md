...
> Opening this brief does **not** schedule it. Hiring remains queued after RPM close. MA-4 Cutover Gate PASS. Leftover-store deletion is not this program. The queue’s Active Product is **[FP-3](external-intake-forms-publish.md)**.
