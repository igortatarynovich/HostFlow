...
**Branch (code):** none this slice — docs only; later feat uses `feat/engine-document-request-dr1-runtime`  
...
|----------|--------------|
| Engine may **create** Hub outstanding asks (docs) | Overlay SoT / CL7 evaluate rewrite |
...
| Runtime write | later feat — not this PR |
| D4 bind | existing Documents surface reads Hub asks (E7); this slice writes them (feat-locked) |
...
Unlocks: later Product via **queue amendment**. Does **not** auto-start E8-bind / E8-eval. Do **not** invent CL8.
...
**Does not:** invent CL8; start E8-bind / E8-eval; mint a Hub request table; mass-generate asks; rewrite Overlay / CL7 evaluate
