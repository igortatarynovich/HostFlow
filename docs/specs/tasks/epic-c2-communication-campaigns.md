...
| **C2.3** | [c2-3-campaign-orchestrator.md](c2-3-campaign-orchestrator.md) | Audience + plan → Intent — **implementation complete, merge gate failed** (PR #121–#126; not Closed until #125+#126 merge) |
...
**Active now:** **C2.3 Campaign Orchestrator** — implementation complete, merge gate failed ([c2-3-campaign-orchestrator.md](c2-3-campaign-orchestrator.md)). Do **not** start C2.4 until PR-5 (#125) and PR-6 (#126) merge.
