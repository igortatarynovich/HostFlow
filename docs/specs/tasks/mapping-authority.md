...
> Queue names Active Product External Intake program close ([brief](external-intake-forms-publish.md); feat locked) after External Intake Acceptance Gate **PASS**. Hiring E2E / min HR remain queued. Unlock ≠ schedule. RS-3 stays Mapping’s proof.
