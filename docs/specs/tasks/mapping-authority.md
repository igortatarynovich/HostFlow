...
> Queue names Active Product **[FP-5](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp5-external-submit` open; External Intake Acceptance Gate **not PASS**) after Operator Publish Gate PASS. Hiring E2E / min HR remain queued. Unlock ≠ schedule. This stamp does not ship runtime. RS-3 stays Mapping’s proof.
