...
> Queue amendment names Active Product **[FP-2](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**) after Forms Publish Contract Gate PASS. Hiring E2E / min HR remain queued. Unlock ≠ schedule.
...
One Active Product slice at a time. RPM program is **DONE**. **MA-1 Contract Gate PASS**. **Mapping Resolution Gate PASS**. **Mapping Operator Gate PASS**. **Mapping Consumer Cutover Gate PASS**. **Mapping program = DONE**. Forms Publish Contract Gate **PASS**. Active Product = **[FP-2](external-intake-forms-publish.md)** (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**).
...
**Active Product after close:** named **[FP-1](external-intake-forms-publish.md)** (brief; feat locked). Forms Publish Contract Gate **PASS** moved Active Product to **[FP-2](external-intake-forms-publish.md)**. Feat `feat/forms-publish-fp2-publish-action` is open; Publish Action Gate **not PASS**.  
**External Intake / Forms Publish:** **FP-2** named Active Product (feat `feat/forms-publish-fp2-publish-action` open; Publish Action Gate **not PASS**). Hiring E2E remains unlocked from RPM, **not** scheduled. min HR remains queued.  
