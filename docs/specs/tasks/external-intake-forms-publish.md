...
> Opening this brief does **not** schedule it. Mapping Operator Gate is PASS; Active Product is MA-4 (feat locked). Intake stays behind Mapping close. The queue’s Active Product is [MA-4](mapping-authority.md).
