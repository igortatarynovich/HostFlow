...
- 2026-07-24: **Connect Source picker enrichment** — thin reuse of `campaign_source_cards` on `GET .../intake-source-options` (Form ID / page / sample ads); [brief](acquisition-ui-cutover-connect-source-picker-enrichment.md). Not C-3.1 scope — separate endpoint.
