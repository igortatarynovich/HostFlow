...
**Status:** **PASS** — Stage 4 product/UI cutover closed (2026-07-27); **Ad-ID bind UI DONE** (#187); Diagnostics PR1 ✅ #196; **Product Track → Source Diagnostics PR2**  
...
**Active slice:** [Source Diagnostics PR2](acquisition-source-diagnostics.md) filters — `/app/marketing/diagnostics`
...
**Queue lock (2026-07-29):** after **Ad-ID bind UI DONE** (#187) → Diagnostics PR1 ✅ #196 → **PR2 filters** active.  
