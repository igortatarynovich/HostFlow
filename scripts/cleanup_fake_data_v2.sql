-- Скрипт для очистки фейковых данных (версия 2 - с удалением всех связанных данных)
...
BEGIN
    ...
    -- Удаляем связанные данные фейковых кандидатов (по порядку зависимостей)
    -- 1. Документы
    ...
    -- 2. Service orders (устанавливаем candidate_id в NULL)
    ...
    GET DIAGNOSTICS deleted_count = ROW_COUNT;
    RAISE NOTICE 'Обновлено service_orders: %', deleted_count;
    
    -- 3. Удаляем фейковых кандидатов
