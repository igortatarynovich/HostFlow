...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — Product Track = **FlightAdBinding Ad-ID bind UI** (Acquisition UI Cutover **C-7 PASS**; Stage 5 PR-2 may resume; then Source Diagnostics).
