...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — **Active slice** = [Entity Platform Completion](docs/specs/tasks/entity-platform-completion.md) (brief; feat locked). D1–D9 are brief-complete / **goal-incomplete** ([audit](docs/specs/gates/platform-scope-completeness-audit.md)). Close-out gate: [`goal-completion-gate.md`](docs/specs/gates/goal-completion-gate.md). E2 brief ✅ ([#271](https://github.com/igortatarynovich/HostFlow/pull/271); **feat locked**). E1 ✅ ([#270](https://github.com/igortatarynovich/HostFlow/pull/270)). Not D10. Not a Recruitment rail patch. Stage 5 settings, R6, Forms P3–P5, OCR, and D3–D9 `documents` bind are **not** this slice.
...
**Active close-out:** [Entity Platform Completion](docs/specs/tasks/entity-platform-completion.md) (restore Entity Shell + contributions; feat locked) → proof screen → [Documents Platform E2](docs/specs/tasks/documents-platform-e2-public-contract.md) (brief ✅ [#271](https://github.com/igortatarynovich/HostFlow/pull/271); feat locked) → later E slices → Billing → AI. D1–D9 brief-complete only. Forms Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Forms P3–P5 stay locked.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ✅ → Entity Workspace D1–D9 (brief-complete) → Entity Platform Completion ← **active** → Documents E2 (feat locked) → Billing → AI.  
Catalog Notifications↔Communication naming requires Architecture RFC (A2-F1) — do not rewrite L0 Catalog without RFC. This slice does not mint Catalog Passport and does not start E2 feat. Future phase COMPLETE requires [Goal Completion Gate](docs/specs/gates/goal-completion-gate.md). New **platform phase briefs** must include `Original Goal → Completion Proof` ([documentation-rules.md](docs/governance/documentation-rules.md) §3.1). Entity Platform Completion is **capability-based** — not a UI-component kit; no further entity/application page multiplication until the E2E proof.
