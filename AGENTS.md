...
**Active close-out:** [Workspace Capability Platform Completion](docs/specs/tasks/workspace-capability-platform-completion.md) [COMPLETE](docs/specs/gates/workspace-capability-platform-complete.md) → [host runtime-equivalence](docs/specs/tasks/workspace-capability-host-runtime-equivalence.md) ✅ → [Documents Platform E2](docs/specs/tasks/documents-platform-e2-public-contract.md) ✅ [#276](https://github.com/igortatarynovich/HostFlow/pull/276) → [Documents Platform E3](docs/specs/tasks/documents-platform-e3-first-consumer-bind.md) ✅ [#278](https://github.com/igortatarynovich/HostFlow/pull/278) → [Documents Platform E4](docs/specs/tasks/documents-platform-e4-candidate-document-link.md) ✅ [#280](https://github.com/igortatarynovich/HostFlow/pull/280) → [Documents Platform E5](docs/specs/tasks/documents-platform-e5-candidate-storage-bridge.md) ✅ [#282](https://github.com/igortatarynovich/HostFlow/pull/282) → [Documents Platform E6](docs/specs/tasks/documents-platform-e6-document-expiry.md) ✅ [#285](https://github.com/igortatarynovich/HostFlow/pull/285) → [Documents Platform E7](docs/specs/tasks/documents-platform-e7-document-requests.md) ✅ [#287](https://github.com/igortatarynovich/HostFlow/pull/287) → [Entity Field Composition CL0](docs/specs/tasks/entity-field-composition-cl0-contract-seal.md) ✅ [#289](https://github.com/igortatarynovich/HostFlow/pull/289) → [Entity Field Composition CL1](docs/specs/tasks/entity-field-composition-cl1-inventory.md) (brief; feat locked) ← **active** → later CL / E slices → Billing → AI. D1–D9 brief-complete only. Forms Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Forms P3–P5 stay locked. Shell `documents` nav ≠ D2 `documents` slot; first consumer ≠ mass bind; G4 ≠ Documents proof. Documents Foundation stays 🔄.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ✅ → Entity Workspace D1–D9 (brief-complete) → Workspace Capability Platform Completion (**COMPLETE** / G4 PASS) → host runtime-equivalence ✅ → Documents E2 ✅ → Documents E3 ✅ → Documents E4 ✅ → Documents E5 ✅ → Documents E6 ✅ → Documents E7 ✅ → Entity Field Composition CL0 ✅ → Entity Field Composition CL1 (brief; feat locked) ← **active** → Billing → AI.  
