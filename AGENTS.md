...
**Active close-out:** [Entity Workspace D4 — Candidate Cutover](docs/specs/tasks/entity-workspace-d4-candidate-cutover.md) (brief; feat locked) → D5+ remaining consumers → Documents → Billing → AI. D3 ✅ ([#256](https://github.com/igortatarynovich/HostFlow/pull/256)). D2 ✅ ([#254](https://github.com/igortatarynovich/HostFlow/pull/254)). D1 ✅ ([#252](https://github.com/igortatarynovich/HostFlow/pull/252)). Forms Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Forms P3–P5 stay locked. Shell `documents` nav ≠ D2 `documents` enable; Documents slot reserved empty until Phase E.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ✅ → Entity Workspace ← **active** (D4 brief; feat locked) → Documents → Billing → AI.  
