...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — Product Track = **Acquisition Stage 6 PR-4** cross-campaign portfolio (PR-3 ✅ #215).
