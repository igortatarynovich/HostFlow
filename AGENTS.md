...
- [ ] Если PR затрагивает модули / shared capabilities / integrations — пройден [`docs/specs/architecture/architecture-review-checklist.md`](docs/specs/architecture/architecture-review-checklist.md) (**P-01 / P-02 / P-03** + Capability Boundary)
...
- Platform rules: **P-01** adapter boundary, **P-02** capability ownership (+ **Capability Boundary** / passports in [`platform-capability-catalog.md`](docs/specs/architecture/platform-capability-catalog.md)), **P-03** capability composition — см. [`docs/specs/architecture/architecture-guide.md`](docs/specs/architecture/architecture-guide.md).
