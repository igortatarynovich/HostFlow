...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — **Active slice** = [Workspace Capability Platform Completion](docs/specs/tasks/workspace-capability-platform-completion.md) (brief; feat locked). Capability Host Contract; Entity Workspace ≠ Application Workspace; proof = Recruitment Application. D1–D9 are brief-complete / **goal-incomplete** ([audit](docs/specs/gates/platform-scope-completeness-audit.md)). Close-out gate: [`goal-completion-gate.md`](docs/specs/gates/goal-completion-gate.md). E2 brief ✅ ([#271](https://github.com/igortatarynovich/HostFlow/pull/271); **feat locked**). E1 ✅ ([#270](https://github.com/igortatarynovich/HostFlow/pull/270)). Not D10. Not a Recruitment rail patch. Stage 5 settings, R6, Forms P3–P5, OCR, and D3–D9 `documents` bind are **not** this slice.
