...
**Active close-out:** [Entity Workspace D8 — HR Employee Cutover](docs/specs/tasks/entity-workspace-d8-hr-employee-cutover.md) (feat; named Cutover Gate) → D9 brief (locked) → Documents → Billing → AI. D7 ✅ ([#264](https://github.com/igortatarynovich/HostFlow/pull/264)). D6 ✅ ([#262](https://github.com/igortatarynovich/HostFlow/pull/262)). D5 ✅ ([#260](https://github.com/igortatarynovich/HostFlow/pull/260)). D4 ✅ ([#258](https://github.com/igortatarynovich/HostFlow/pull/258)). D3 ✅ ([#256](https://github.com/igortatarynovich/HostFlow/pull/256)). D2 ✅ ([#254](https://github.com/igortatarynovich/HostFlow/pull/254)). D1 ✅ ([#252](https://github.com/igortatarynovich/HostFlow/pull/252)). Forms Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Forms P3–P5 stay locked. Shell `documents` nav ≠ D2 `documents` enable; Documents slot reserved empty until Phase E.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ✅ → Entity Workspace ← **active** (D8 feat; D9 brief locked) → Documents → Billing → AI.  
Catalog Notifications↔Communication naming requires Architecture RFC (A2-F1) — do not rewrite L0 Catalog without RFC. D8 does not mint Entity Catalog Passport and does not enable D2 `documents`.
