...
**Active close-out:** [Entity Workspace D6 — Sales Order Cutover](docs/specs/tasks/entity-workspace-d6-sales-order-cutover.md) (feat; named Cutover Gate) → D7 brief (locked) → Documents → Billing → AI. D5 ✅ ([#260](https://github.com/igortatarynovich/HostFlow/pull/260)). D4 ✅ ([#258](https://github.com/igortatarynovich/HostFlow/pull/258)). D3 ✅ ([#256](https://github.com/igortatarynovich/HostFlow/pull/256)). D2 ✅ ([#254](https://github.com/igortatarynovich/HostFlow/pull/254)). D1 ✅ ([#252](https://github.com/igortatarynovich/HostFlow/pull/252)). Forms Foundation ✅ ([#250](https://github.com/igortatarynovich/HostFlow/pull/250)). Forms P3–P5 stay locked. Shell `documents` nav ≠ D2 `documents` enable; Documents slot reserved empty until Phase E.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ✅ → Entity Workspace ← **active** (D6 feat; D7 brief locked) → Documents → Billing → AI.  
Catalog Notifications↔Communication naming requires Architecture RFC (A2-F1) — do not rewrite L0 Catalog without RFC. D6 does not mint Entity Catalog Passport and does not enable D2 `documents`.
