...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — Product Track = [Acquisition UI Cutover](docs/specs/tasks/acquisition-ui-cutover.md) (Stage 4 runtime DONE; product/UI cutover NOT DONE; Stage 5 PR-2 paused).
