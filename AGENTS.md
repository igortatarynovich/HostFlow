...
Near-term slices: [`docs/specs/tasks/sales-to-comms-sequential-queue.md`](docs/specs/tasks/sales-to-comms-sequential-queue.md) — **Active slice** = [Forms Platform C4 Form Runtime](docs/specs/tasks/forms-platform-c4-form-runtime.md) (feat; Runtime Model). C1–C3 ✅ ([#244](https://github.com/igortatarynovich/HostFlow/pull/244)). Brief [#245](https://github.com/igortatarynovich/HostFlow/pull/245). Stage 5 settings and R6 are **not** this slice. Forms C4 ≠ Sprint HTTP `test_forms_platform_c4.py`.
...
**Active close-out:** [Forms Platform C4 Form Runtime](docs/specs/tasks/forms-platform-c4-form-runtime.md) (feat — Runtime Model) → C5 Form Execution → C6 Optimization → Entity Workspace → Documents → Billing → AI. C1–C3 ✅ ([#244](https://github.com/igortatarynovich/HostFlow/pull/244)). Brief [#245](https://github.com/igortatarynovich/HostFlow/pull/245). Phase B Meta/slice 3–4 ✅. P3 Publish UI / P4 Themes / C5 stay locked.

**Locked:** Acquisition/Stage 3 (Phase B) ✅ → Forms Platform ← **active** (C4 feat; C1–C3 ✅) → Entity Workspace → Documents → Billing → AI.  
