    ...
    async with _BOOTSTRAP_LOCK:
        ...
        async with async_session_maker() as session:
            ...
            if supervisor is None:
                ...
                prefs = dict(supervisor.preferences or {}) if isinstance(supervisor.preferences, dict) else {}
            ...
            if recruiter is None:
                ...
                prefs = dict(recruiter.preferences or {}) if isinstance(recruiter.preferences, dict) else {}
            ...
            if hr_officer is None:
                ...
                prefs = dict(hr_officer.preferences or {}) if isinstance(hr_officer.preferences, dict) else {}
                prefs["preset_id"] = "hr"
