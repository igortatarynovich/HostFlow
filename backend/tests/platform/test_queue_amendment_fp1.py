...
Current Active Product is FP-3 (feat open; Public Serve Gate not PASS)
after Publish Action Gate PASS. Hiring / min HR remain queued. Leftover-store
...
def test_fp1_amendment_history_then_contract_gate() -> None:
    ...
    assert "Public Serve Gate **not PASS**" in intake_current
