...
_D3_D4_D5_D6_D7_D8_D9_CONSUMER_PATHS = (
    ...
    "pages/Companies.tsx",
    "components/clients/ClientCommunicationSlot.tsx",
    "components/clients/ClientFormsSlot.tsx",
    "pages/sales/SalesOrderDetailPage.tsx",
    "components/sales/SalesOrderCommunicationSlot.tsx",
    "components/sales/SalesOrderFormsSlot.tsx",
    "components/vacancies/VacancyDetail.tsx",
    "components/vacancies/VacancyCommunicationSlot.tsx",
    "components/vacancies/VacancyFormsSlot.tsx",
...
def test_d2_no_consumer_cutover_screens() -> None:
    leaked: list[str] = []
    allowed = set(_D3_D4_D5_D6_D7_D8_D9_CONSUMER_PATHS)
