...
@pytest.mark.anyio
async def test_application_received_not_sent_for_sales_inquiry_destination(monkeypatch):
    """SalesInquiry-bound transport lead must not get recruitment application_received."""
    sent: List[dict[str, Any]] = []
