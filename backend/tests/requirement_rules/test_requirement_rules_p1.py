...
from backend.app.entity_profile.constants import DRIVER_CE_PROFILE_CODE, REQUIREMENT_REQUIRED
...
def test_p1_document_pack_manifest_driver_ce() -> None:
    ...
    codes = {row["document_type_code"] for row in pack["required_documents"]}
    assert codes == {"passport", "driver_license", "code95", "tacho_card"}
