...
async def rematch_unlinked_threads(
    ...
    """G15 rematch endpoint.

    Full inbound-matching service is not on this release line yet; return a
    structured no-op so the UI does not hit Method Not Allowed on
    ...
    _ = own_company_id  # scope reserved for full G15 restore
