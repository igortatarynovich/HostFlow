...
# Trial volume = paid Team (not a 50-lead sandbox). Product policy: evaluate the full product.
TRIAL_LEADS_MONTHLY_CAP = 1500
TRIAL_CONVERSION_ACTIONS_CAP = 1500
TRIAL_PORTAL_SHARES_CAP = 300
TRIAL_AUTOMATION_RUNS_CAP = 10_000
