    ...
    if bt == "services":
        ...
        if bt == "employer":
            specs = [
                ...
                {"stage": "screening", "reminder": False, "old": False, "first_name": "Maria", "last_name": "Wiśniewska"},
                {"stage": "screening", "reminder": False, "old": False, "first_name": "Piotr", "last_name": "Lewandowski"},
                {"stage": "screening", "reminder": False, "old": False, "first_name": "Ewa", "last_name": "Zielińska"},
                {"stage": "interview", "reminder": True, "old": True, "first_name": "Stuck", "last_name": "Interview A"},
                {"stage": "interview", "reminder": True, "old": True, "first_name": "Stuck", "last_name": "Interview B"},
                {"stage": "offer", "reminder": True, "old": False, "first_name": "Tomasz", "last_name": "Kamiński"},
                {"stage": "offer", "reminder": True, "old": False, "first_name": "Katarzyna", "last_name": "Szymańska"},
                {"stage": "screening", "reminder": True, "old": False, "first_name": "Michał", "last_name": "Woźniak"},
                {"stage": "interview", "reminder": True, "old": False, "first_name": "Agnieszka", "last_name": "Dąbrowska"},
            ...
            specs = [
                ...
                {"stage": "waiting_docs", "reminder": True, "old": True, "first_name": "Docs", "last_name": "Stuck A"},
                {"stage": "waiting_docs", "reminder": True, "old": True, "first_name": "Docs", "last_name": "Stuck B"},
                {"stage": "docs_received", "reminder": True, "old": False, "first_name": "Demo", "last_name": "Charlie"},
                {"stage": "docs_received", "reminder": True, "old": False, "first_name": "Demo", "last_name": "Delta"},
                {"stage": "ready_client", "reminder": True, "old": False, "first_name": "Demo", "last_name": "Echo"},
                {"stage": "ready_client", "reminder": True, "old": False, "first_name": "Demo", "last_name": "Foxtrot"},
                {"stage": "handoff", "reminder": True, "old": False, "first_name": "Demo", "last_name": "Golf"},
            ]
            summary["stuck"] = 2
